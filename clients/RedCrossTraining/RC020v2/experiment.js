...
var _RC020V2 = (function () {
	...
	var UC=function(a){return a.poller=function(a,b,c){var d={wait:50,multiplier:0,timeout:7000},e=Date.now||function(){return(new Date).getTime()};if(c)for(var f in c)d[f]=c[f];else c=d;for(var g=!!d.timeout&&new Date(e()+d.timeout),h=d.wait,i=d.multiplier,j=[],l=function(c,d){if(g&&e()>g)return!1;d=d||h,function(){var a=typeof c;return"function"===a?c():"string"!==a||document.querySelector(c)}()?(j.push(!0),j.length===a.length&&b()):setTimeout(function(){l(c,d*i)},d)},m=0;m<a.length;m++)l(a[m])},a}(UC||{});
		...
		UC.poller([
			'body',
			'.desktop-homepage .row #main_0_homepagemidcomponents_0_ContainerDiv',
			function () {
	   ...
	   ---------------------------------*/
			...
			var lifesavebox = $('.rc20v2-newBlocks .rc20-block:first'),
				whyTrainbox = $('.rc20v2-newBlocks .rc20-block:eq(1)'),
				learnbox = $('.rc20v2-newBlocks .rc20-block:last'),
				linkName;
			...
			lifesavebox.find('.rc20-link a').click(function () {
				...
				if (!lifesaveEvent) {
					sendEvent('RC020 V2', 'Page View', 'RC020 User clicked ' + linkName + ' link', true);
					lifesaveEvent = true;
				}
			});
