var _RC019 = (function () {
	...
	var topTextWorkplace = $([
		"<p>We are one of the UK's leading first aid training providers, with over 35 years' experience in delivering first aid at work courses. We train over 120,000 people every year and we are the chosen provider for over 100,000 UK customers, from small businesses to multinational enterprises.</p>",
		  '<p>We offer scheduled first aid and health and safety courses (which can be delivered in-house for <a href="https://www.redcrossfirstaidtraining.co.uk/What-we-do/Group-bookings.aspx">groups of up to 15 staff</a>), a selection of in-company only courses, and we can even provide bespoke training as part of our <a href="https://www.redcrossfirstaidtraining.co.uk/What-we-do/key-account-management-service">Key Account management service.</a> Please <a href="https://www.redcrossfirstaidtraining.co.uk/Contact-us">contact us</a> to discuss how we can meet your training needs.</p>'
	  ].join(''));
	var topTextPublic = $([
	 '<p>We offer a range of first aid courses for people over the age of 16 who want to learn first aid for their everyday life, rather than as a requirement of their job*. </p>',
	  '<p>They cover first aid for babies and children (from birth to puberty) and adults (puberty onwards) and are available at venues across the UK, or at a location to suit you if you have a <a href="https://www.redcrossfirstaidtraining.co.uk/What-we-do/Group-bookings.aspx">group of up to 15 people.</a></p>',
	  ...
	  '<p class="rc19-smallText"><b>*NB</b> If you need first aid training to meet health and safety requirements, please see our <a href="https://www.redcrossfirstaidtraining.co.uk/Courses/First-aid-at-work-courses-uk-mainland.aspx">workplace first aid courses.</a></p>'
		].join(''));
   ...
   Change all workplace in company course button text to enquire
	...
	/*Other courses event*/
		...
		$('.table-responsive tr').each(function(){
		  $(this).find('.rc19-othercourseLink').click(function(){
			if(!otherCoursefindevent){
			  sendEvent('RC019', 'click', 'RC019 - All courses redesign - User clicked find courses on all courses', true);
			  otherCoursefindevent = true;
			} 
		  });
		  $(this).find('.rc19-othercourseLearnmore').click(function(){
			if(!othercourseLearnevent){
			  sendEvent('RC019', 'click', 'RC019 - All courses redesign - User clicked learn more on all courses', true);
	  ...
	  // -----------------------------------------------
		//When course finder clicked on RC018 click RC017 course finder tab
	  // -----------------------------------------------
