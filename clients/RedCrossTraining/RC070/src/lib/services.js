        ...
        <div class="${shared.ID}-lightbox__container">
          ...
          <div  class="${shared.ID}-lightbox__subheader">
            <div class="${shared.ID}-lightbox__contentWrapper">
              <span  class="${shared.ID}-lightbox__title">Need help finding a course?</span>
              <span class="${shared.ID}-lightbox__subtitle">Let us help you find the perfect course</span>
            </div>
          </div>
          <ul class="${shared.ID}-lightbox__content-wrapper">
          </ul>
          <ul class="${shared.ID}-course__cta-wrapper">
            <li class="${shared.ID}-course__cta">
              <a href="/courses/">
                <button type="submit" class="cta">
                  <span>All courses</span>
                </button>
              </a>
              <div>All our workplace and public courses</div>
            </li>
            <li class="${shared.ID}-course__cta">
              <a href="/courses/choose-the-right-course/">
                <button type="submit" class="cta">
                  <span>Course finder</span>
                </button>
              </a>
              <div>Our useful tool to find the right course for you</div>
            </li>
