var _RC004 = (function($) {
    ...
    function wholeExperiment (runIt) {
        ...
        var courseTypeHtml = [
            ...
            '<span class="RC022_workplace_option"><img src="https://ab-test-sandbox.userconversion.com/experiments/RC022-house.png"><span class="RC022_workplaceTitle">Workplace</span></span>',
            '<span class="RC022_courseType_description">We are one of the UK\'s leading first aid training providers, with over 35 years\' experience in delivering first aid work courses. We train over 120,000 people every year and we are the chosen provider for over 100,000 UK customers, from small businesses to multinational enterprises.</span>',
            '</div>',
            '<span class="RC022_justOR">or</span>',
            '<div class="RC022_courseType_innerWrapper">',
            '<span class="RC022_public_option"><img src="https://ab-test-sandbox.userconversion.com/experiments/RC022-building.png"><span class="RC022_publicTitle">Public</span></span>',
            '<span class="RC022_courseType_description">We are one of the UK\'s leading first aid training providers, with over 35 years\' experience in delivering first aid work courses. We train over 120,000 people every year and we are the chosen provider for over 100,000 UK customers, from small businesses to multinational enterprises.</span>',
            '</div>',
            '</div>'
        ].join('');
