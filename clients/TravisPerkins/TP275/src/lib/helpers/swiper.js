  ...
  !(function (e, t) {
    ...
    const re = [
      ...
      function (e) {
        ...
        te({
          ...
          setTranslate: () => {
            ...
            if (
              (s.css({ '-webkit-transform-origin': `50% 50% -${o / 2}px`, 'transform-origin': `50% 50% -${o / 2}px` }), p.shadow)
            )
              if (u)
                m.transform(
      ...
      function (e) {
        let { swiper: t, extendParams: s, on: a } = e;
        s({
          coverflowEffect: { rotate: 50, stretch: 0, depth: 100, scale: 1, modifier: 1, slideShadows: !0, transformEl: null },
        }),
          te({
            effect: 'coverflow',
            swiper: t,
