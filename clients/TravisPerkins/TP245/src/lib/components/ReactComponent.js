            ...
            return (
                ...
                <div className={`${shared.ID}__calculator`}>                    
                    <div className={`${this.state.expanded ? `${shared.ID}__calculator__title` : `${shared.ID}__calculator__title--expanded`}`} onClick={this.handleExpansion}>
                        ...
                        <svg className={`${this.state.expanded ? `${shared.ID}__chevron__down__display`: `${shared.ID}__chevron__down`}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M201.4 374.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 306.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>  
                        <svg className={`${this.state.expanded ? `${shared.ID}__chevron__up`: `${shared.ID}__chevron__down__display`}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M201.4 137.4c12.5-12.5 32.8-12.5 45.3 0l160 160c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L224 205.3 86.6 342.6c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l160-160z"/></svg>                     
                    </div>
