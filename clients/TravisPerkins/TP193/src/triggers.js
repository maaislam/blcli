...
if (!ieChecks) {
  pollerLite(
    [
      ...
      "#app-container",
      () => {
        // When user goes to other pages first, it might take a while to get to checkout
        // Therefore, checking for checkout here might mean poller stops polling before checkout is reached.
        // Instead, we check for this in the activate() function.
