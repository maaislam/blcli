...
function addBrochure(ref) {
  if (ref) {
    if (!document.querySelector('.TP137m-brochure')) {
      ref.insertAdjacentHTML('afterend', `
        <div class="TP137m-brochure">
          <div class="TP137m-brochure--img" style="background: url('https://prod1-tp01-prod02-aws-travisperkins-com-public.s3.amazonaws.com/sys-master/images/ha2/hf6/8886665871390/Gardens%20Brochure.png') no-repeat center center;">
