var _TP044 = (function () {
    ...
    if (window.location.href.indexOf('?q=%3Arelevance&perPage=') === -1
        && $('.left.perpage_list > li:last a').text().trim() === '120') { // not queried to the other 'view' options either
