    ...
    function sendEvent(e,n,a,r,t,o){var c=function(c){var i={};i.nonInteraction=r,t&&o&&(i["dimension"+t]=o),window.ga(c+".send","event",e,n,a,i)};trackerName?c(trackerName):UC.poller([function(){return window.ga.getAll}],function(){trackerName=window.ga.getAll()[0].get("name"),c(trackerName)})}var trackerName;
			...
			UC.poller([
				...
				UC.poller([
				   ...
				   var $ = window.jQuery;
					$('body').addClass('TP051V2');

					sendEvent('TP051', 'Page View', 'TP051 V2 Highlight Technical Specs (mobile) Page view', true);
		...
		var linksWrapper = $('<div class="tp51-toplinks"/>');

		linksWrapper.insertAfter('.tp_prodName');
		...
		$.each(links,function(){
			...
			$(['<a class="tp51-toptablink" href="#tp26_overview">',
					'<img src="'+icon+'"/>',
					'<p>'+tabName+'</p>',
			   '</a>'].join('')).appendTo('.tp51-toplinks');
		});



		var topTabs = $('.tp51-toplinks');
		var overview = $('#tp26_overview .tp26_tab-link:eq(0)'),
			technicalSpecs = $('#tp26_overview .tp26_tab-link:eq(1)'),
			overviewTab = $('#tab-1'),	
			techspecTab = $('#tab-2');
		...
		---------------------------------*/
			$('.tp51-toptablink').on('click', function(e) {
		...
		---------------------------------*/
		topTabs.find('.tp51-toptablink:first').click(function(){
				overview.addClass('current');
				overviewTab.addClass('current');

				technicalSpecs.removeClass('current');
				techspecTab.removeClass('current');
		...
		---------------------------------*/
		topTabs.find('.tp51-toptablink:last').click(function(){
			overview.removeClass('current');
			overviewTab.removeClass('current');

			technicalSpecs.addClass('current');
			techspecTab.addClass('current');
		...
		technicalSpecs.click(function(){
		if(!specsClick){
			sendEvent('TP051', 'Page View', 'TP051 V2 user clicked on tech specs tab', true);
			 specsClick = true;
		  }
		});
           ...
           overview.click(function(){
            if(!overviewClick){
				sendEvent('TP051', 'Page View', 'TP051 V2 user clicked on overview tab', true);
                 overviewClick = true;
		  }
		 });


            $('.tp51-toptablink:first').click(function(){
              if(!topOverviewlinkclick){
                sendEvent('TP051', 'Page View', 'TP051 V2 user clicked on top overview link', true);
                topOverviewlinkclick = true;
            }
		 });

           $('.tp51-toptablink:last').click(function(){
              if(!topTechnicallinkclick){
                sendEvent('TP051', 'Page View', 'TP051 V2 user clicked on top tech spec link', true);
...
// 				for (var n = this.active, e = 0; e < t.length; e++)
// 					for (var o = t[e], r = 0; r < n.length; r++) o === n[r][0] && n[r][1].disconnect()
// 			}
...
// 					}), a.css({
// 						height: t.contentDimensions.height,
// 						width: t.contentDimensions.width
// 					}), e
// 				},
// 				c = function () {
...
// 				},
// 				u = function () {
// 					var t = n(".UC_fb-tab-container"),
// 						e = t.children(".UC_fb-tab"),
// 						o = t.children(".UC_fb-content"),
// 						r = n(window);
// 					return {
// 						window: {
// 							width: r.innerWidth(),
...
// 				h = function (n) {
// 					if (!n) return !1;
// 					var e = n.find(".UC_fb-tab"),
// 						r = n.find(".UC_fb-content"),
// 						s = "closed";
// 					e.click(function () {
// 						var e, f, l;
...
// 		console.log('load');
// 		var $ = window.jQuery;
// 		$('body').addClass('TP051V3');


// 		sendEvent('TP051', 'Page View', 'TP051 V3 Highlight Technical Specs (mobile) Page view', true);
// 		/*-------------------------------
// 		Add two links above the product picture on product pages 
// 		---------------------------------*/
...
// 		technicalSpecs.closest('#tp26_overview').find('.tp26_tab-link:first').removeClass('current');
// 		techspecTab.closest('#tp26_overview').find('#tab-1').removeClass('current');
// 		technicalSpecs.addClass('current');
// 		techspecTab.addClass('current');
...
// 		technicalSpecs.click(function () {
// 			if (!specsClick) {
// 				sendEvent('TP051', 'Page View', 'TP051 V3 user clicked on tech specs tab', true);
// 				specsClick = true;
// 			}
// 		});
...
// 		overview.click(function () {
// 			if (!overviewClick) {
// 				sendEvent('TP051', 'Page View', 'TP051 V3 user clicked on overview tab', true);
// 				overviewClick = true;
// 			}
// 		});
...
// 		$('.tp51-toptablink:first').click(function () {
// 			if (!topOverviewlinkclick) {
// 				sendEvent('TP051', 'Page View', 'TP051 V3 user clicked on top overview link', true);
// 				topOverviewlinkclick = true;
// 			}
// 		});
...
// 		$('.tp51-toptablink:last').click(function () {
// 			if (!topTechnicallinkclick) {
// 				sendEvent('TP051', 'Page View', 'TP051 V3 user clicked on top tech spec link', true);
// 				topTechnicallinkclick = true;
// 			}
// 		});
