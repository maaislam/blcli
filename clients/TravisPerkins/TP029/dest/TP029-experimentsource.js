var _TP029 = (function() {
    ...
    UC.poller([
        '#tp_product_lister_sort_grid_on',
        function() {
        ...
        // EXPERIMENT
        var $ = window.jQuery;
        // Don't run the scripts twice!
        if ($('body').hasClass('TP029')) return false;
        ...
        $('#tp_product_lister_sort_grid_on').trigger('click');
    } // activate
})();