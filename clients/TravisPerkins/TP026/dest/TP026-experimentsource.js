    ...
    function TP026() {
    	...
    	var deliveryMessage = {
    		freeDeliv: {
    			...
    			smallText: 'All our products can be delivered safely and securely to your chosen destination from one of our XXX branches nationwide',
    		},
    		over50: {
    			icon: '',
    	...
    	var expObj;
    	var productName = $('.tpProductTitle').text().trim();
    	...
    	if (productName.indexOf("Bulk") >= 0 && priceincVatnumber > 30) {
