...
const { ID } = shared;
const noticePLP = `<p class="${ID}_notice"><strong>Day of choice</strong> delivery available</p>`;
const noticePDP = `<p class="${ID}_notice"><strong>Day of choice</strong> delivery available</p>`;
const noticePopup = `
...
const noticeCart = "Day of choice delivery is available";

const getPostcodeModal = () => {
  return document.querySelector('[data-test-id="delivery-address-popup"]');
};
