...
const init = () => {
  ...
  if (VARIATION == '1') {
    const mobileHeaderBar = document.querySelector('[data-test-id="order-hub-header"]');
    const desktopHeaderBar = document.querySelector('[data-test-id="order-hub-header"]');
    ...
    const desktopAnchorPoint = document.querySelector('[data-test-id="basket-entries-section"]');
    const mobileAnchorPoint = document.querySelector('[data-test-id="basket-entries-section"]');
