...
const variation2 = () => {
  ...
  pollerLite([".oct-carousel-hero .swiper-slide"], () => {
    ...
    const runExperiment = (carousel) => {
      const carouselSlides = carousel.querySelectorAll(".swiper-slide");

      const targetSlides = [carouselSlides[1], carouselSlides[3]];
          ...
          <div class="${ID}-promo-banner">
            ...
            <div class="${ID}-promo-content">
              ...
              <p class="${ID}-promo-small-print">
                9/10 said their skin felt smoother after two weeks* brought to
                you by the #1 foundation brand in Britain
              </p>
            </div>
          </div>
        `;
