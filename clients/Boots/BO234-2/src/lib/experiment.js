...
export default () => {
  ...
  <div class="pc-banner__points">
    <p><b>Double Points Event!</b> Collect <span class="points">${newPoints}</span> points with this purchase when you join the Parenting Club = <span class="amount">£${value.toFixed(2)}</span> to spend online*</p>

  </div>
  <div class="pc-terms">
    <p>For a limited time, join Boots Parenting Club & get 16 points for every £1 spend on eligible baby products</p>
