...
export default () => {
	...
	if (VARIATION == "control") {
		...
		// 	[".pdp-promotion-redesign.member_price_advantage span.member_price_advantage", () => document.readyState === "complete"],
		// 	() => {
				// -----------------------------
	...
	// pollerLite([""], () => {
		...
		if (!excludedSkus[sku]) {
			...
			const isLoggedInWithoutAdcardUser =
				window.userObj.isLoggedIn == "true" && window.userObj.advantageCardFlag == "false";
			// console.log(isLoggedInWithoutAdcardUser, 'isLoggedInWithoutAdcardUser');
			...
			// 	} else 
				...
				const pointsWidget = document.querySelector('.estore_adcard_points_to_earn_widget');
				if(pointsWidget) {
					pointsWidget.style.display = 'none';
				}
				...
				} else if (isLoggedInWithoutAdcardUser === true) {
					// console.log('isLoggedInWithoutAdcardUser');
					parentBanner.innerHTML = `
								<div class="pc-logo"></div>
								<div class="pc-banner__points">
            ...
            //                     </div>`;
			// 	} else if (isLoggedInWithoutAdcardUser !== "false") {
			// 		parentBanner.innerHTML = `
			// 					<div class="pc-logo"></div>
			// 					<div class="pc-banner__points">
			// 					  <p>You will earn ${pointsNo} points with this purchase. Find out about your Advantage Card points and benefits in my account.</p>
            ...
            //                     </div>
            //                     <div class="parenting-club">
			// 					<a class="pc-button" href="/advantage-card">Log In</a>
			// 					<a class="pc-button" href="/advantage-card">Sign Up</a>
            //                     </div>`;
			// 	}
