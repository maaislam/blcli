...
const testID = `${ID}|Offer Based component`; // Change this to test name and include in experiment.js
...
if (!ieChecks) {
  if (!getCookie('Synthetic_Testing')) {
    ...
    pollerLite(['body', '.oct-decorative-panel__inner__content .oct-grid-aem__cell__width--firstRow div[data-testid="grid"]'], () => setTimeout(activate, 1000));
  }
}
