...
const testID = `${ID}|insert test name`; // Change this to test name and include in experiment.js
...
if (!ieChecks) {
  if (!getCookie('Synthetic_Testing')) {
    ...
    pollerLite(['body', () => document.querySelectorAll('#topLevelMenu > .topLevelMenuListItem').length === 6], activate);
  }
}
