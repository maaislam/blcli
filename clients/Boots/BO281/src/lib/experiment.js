...
export default () => {
  ...
  if(VARIATION == 'control') {
    if (data !== undefined) {
      fireEvent("Interaction - URL found - markup would be added to page but is not because this is the control", true);
    } 
  } else {
    if(data !== undefined) {
      ...
      fireEvent("Interaction - URL found - proceeding to add markup to page", true);

    } else {
      logMessage("No data found for this product");
    }
