...
const testID = `${ID}|Restyling of XMAS gift finder`; // Change this to test name and include in experiment.js
...
if (!ieChecks) {
  if (!getCookie('Synthetic_Testing')) {
    ...
    pollerLite(
      [
        () =>
          document.querySelector('oct-listers-facets-wrapper.oct-listers__loaded') || document.querySelector('.oct-listers-hits'),
      ],
      () => {
