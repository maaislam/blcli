                ...
                const observer = new MutationObserver(function(mutations) {
                        mutations.forEach(function(mutation) {
                            if (oldHref != document.location.href) {
                                ...
                                document.documentElement.classList.remove('BO252');
                                document.documentElement.classList.remove('BO252-1');
                                const filterBlock = document.querySelector('.BO252-heroFilters');
                                if(filterBlock) {
                                    filterBlock.remove();
                                }
                            }
