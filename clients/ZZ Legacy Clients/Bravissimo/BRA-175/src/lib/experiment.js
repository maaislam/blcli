  ...
  if(container) {
    ...
    if(currentBagItems && currentBagItems.length) {
              ...
              <a class="c-product-summary__container u-block-link" 
                ...
                <div class="c-product-summary__main">
                  <div class="c-product-summary__title">
                    ...
                    <h3 class="c-product-summary__name">${item.brandName} ${item.styleName}</h3>
                  </div>
      ...
      container.insertAdjacentHTML('afterbegin', `
        <div class="${ID}-container l-grid l-grid--wraps">
          <div class="l-grid__unit">
            <h2>Welcome Back!</h2>
            <p class="${ID}-container__subtitle">It looks like you have items in your bag</p>
      ...
      const runSlick = () => {
        ...
        const toShow = window.screen.width <= 375 ? 2 : 3;
