...
const Run = () => {
  ...
  const Exp = {
    ...
    cache: (() => {
      ...
      const pageContainer = docVar.getElementById('hero');
      // Reassigned when slick is loading
      let HH005SlickParent;
      let JQHH005SlickParent;
      ...
      slickSlider() {
        const USPCarousel = () => {
          ...
          <div class="HH005_Wrap">
            <section class="landing_wrap HH005_Slider">
              <div class="HH005_Content_Wrap">
                  <a href="/about-us/why-choose-helping-hands/" class="HH005_USP_Link" data-hh005="USP 1">
                    ...
                    <span class="HH005_USP_Text">We invest in our carers: family-run home care that is local to <br />you</span>
                  </a>
                  <a href="/home-care-services/" class="HH005_USP_Link" data-hh005="USP 2">
                    ...
                    <span class="HH005_USP_Text">Fast-response support: from 30-min visits to 24hr live-in <br /> care</span>
                  </a>
                  <a href="/about-us/cqc-regulated-service/" class="HH005_USP_Link" data-hh005="USP 3">
                    ...
                    <span class="HH005_USP_Text">Homecare’s only Centre of Excellence, regulated by CQC & CIW</span>
                  </a>
              </div>
            </section>
          </div>
        `);
          // Assign Selectors
          Exp.cache.HH005SlickParent = Exp.cache.bodyVar.querySelector('.HH005_Wrap > section > .HH005_Content_Wrap');
          Exp.cache.JQHH005SlickParent = $(Exp.cache.HH005SlickParent);
          Exp.cache.bodyVar.querySelector('.landing_wrap.HH005_Slider').className = 'HH005_landing_wrap HH005_Content_Carousel';
          Exp.cache.HH005SlickParent.classList.add('HH005_landing_slider');
          Exp.cache.HH005SlickParent.classList.remove('landing_slider');
          // Configure Slick
          Exp.cache.JQHH005SlickParent.slick({
            slidesToShow: 3,
            slidesToScroll: 1,
            infinite: false,
            arrows: false,
    ...
    bindExperimentEvents: {
      ...
      trackUSP() {
        const USPS = Exp.cache.bodyVar.querySelectorAll('.HH005_USP_Link');
