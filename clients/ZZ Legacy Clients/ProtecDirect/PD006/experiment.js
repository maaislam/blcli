...
(function () {
	...
	function PD006() {
		...
		if(URL === 'https://www.protecdirect.co.uk/' || URL === 'https://www.protecdirect.co.uk'){
		...
		var slides = [
			['pd6-background1', 'http://www.protecdirect.co.uk/Site-Equipment-and-Consumables/Roadworks-and-Equipment/Cold-Weather-Essentials~c~DAI?utm_source=Homepage&utm_medium=Banner&utm_campaign=Brave_the_weather(13.09.2017)'],
			['pd6-background2', 'http://www.protecdirect.co.uk/Clothing-and-Workwear/Hi-Vis-Clothing/Hi-Vis-Waistcoats/TP500-Hi-Vis-Saturn-Yellow-Waistcoat~p~TP500SY?utm_source=Homepage&utm_medium=Banner&utm_campaign=Monday_Hi_Vis_Sept_Offer(25.09.2017)']
			//['pd6-background3', '#']
		]
...
(function() {
	...
	function PD006() {
		...
		if(URL === 'https://www.protecdirect.co.uk/' || URL === 'https://www.protecdirect.co.uk'){
			...
			var category = [
				['http://www.protecdirect.co.uk/Personal-Protective-Equipment-PPE-~c~A', 'Over 100 different items to suit your needs', 'https://ab-test-sandbox.userconversion.com/experiments/PD006-ppenew.png'],
				['http://www.protecdirect.co.uk/Personal-Protective-Equipment-PPE-/Hand-Protection~c~AF', 'Free delivery on all items', 'https://ab-test-sandbox.userconversion.com/experiments/PD006-HANDS.png'],
				['http://www.protecdirect.co.uk/Personal-Protective-Equipment-PPE-/Respiratory-Protective-Equipment~c~AE', 'Over 100 different items to suit your needs', 'https://ab-test-sandbox.userconversion.com/experiments/PD006-RESPI.png'],
				['http://www.protecdirect.co.uk/Personal-Protective-Equipment-PPE-/Safety-Footwear~c~AG', 'Free delivery on all items', 'https://ab-test-sandbox.userconversion.com/experiments/PD006-footwear.png'],
				['http://www.protecdirect.co.uk/Clothing-and-Workwear~c~B', 'Over 100 different items to suit your needs', 'https://ab-test-sandbox.userconversion.com/experiments/PD006-clothing.png'],
				['http://www.protecdirect.co.uk/Site-Equipment-and-Consumables~c~D', 'Free delivery on all items', 'https://ab-test-sandbox.userconversion.com/experiments/PD006-cones.png']
			]
...
(function() {
	...
	// cutoff.setUTCHours(16, 0, 0);
	// cutoff = cutoff.getTime();
	var cutoff = window.PD006.cutoff;
