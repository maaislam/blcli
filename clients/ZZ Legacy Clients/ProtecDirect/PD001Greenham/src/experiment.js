...
(function() {
    ...
    function run() {
        ...
        var menu = $([
            '<div class="pd1_navigation">',
                '<div class="pd1_navigation__item">',
                    '<a href="/Personal-Protective-Equipment~c~A" title="PPE" class="">Personal Protective Equipment</a></div>',
                '<div class="pd1_navigation__item">',
                    '<a href="/Cleaning-and-Hygiene~c~B" title="Cleaning & Hygiene" class="">Cleaning & Hygiene</a></div>',
                '<div class="pd1_navigation__item">',
                    '<a href="/Contractors-Equipment~c~C" title="Contractors Equipment" class="">Contractors Equipment</a></div>',
                '<div class="pd1_navigation__item">',
                    '<a href="/Special-Offers~c~D" title="Special Offers" class="">Special Offers</a>',
                '</div>',
            '</div>'
        ].join(''));
        ...
        // -----------------------------------------------
            ...
            headerLinks.find('.ui-block-c .btn-contactus em').text('0845 300 6672');
