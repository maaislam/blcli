...
(function () {
  ...
  function run() {
    ...
    var menu = $([
      ...
      '<a href="/Personal-Protective-Equipment-PPE-~c~NSSA" title="PPE" class="">PPE</a></div>',
      '<div class="pd1_navigation__item">',
      '<a href="/Personal-Protective-Equipment-PPE-/Hand-Protection~c~NSSAF" title="Gloves" class="">Gloves</a></div>',
      '<div class="pd1_navigation__item">',
      '<a href="/Personal-Protective-Equipment-PPE-/Respiratory-Protective-Equipment~c~NSSAE" title="Respirators" class="">Respirators</a></div>',
      '<div class="pd1_navigation__item">',
      '<a href="/Personal-Protective-Equipment-PPE-/Safety-Footwear~c~NSSAG" title="Footwear" class="">Footwear</a></div>',
      '<div class="pd1_navigation__item">',
      '<a href="/Clothing-and-Workwear~c~NSSB" title="Clothing & Workwear" class="">Clothing & Workwear</a></div>',
      '<div class="pd1_navigation__item">',
      '<a href="/Site-Equipment-and-Consumables~c~NSSD" title="Consumables" class="">Consumables</a></div>',
      '</div>'
    ].join(''));
    ...
    headerLinks.find('.ui-block-c .btn-contactus em').text('0870 903 0361');
