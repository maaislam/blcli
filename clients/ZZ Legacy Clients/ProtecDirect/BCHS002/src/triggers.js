...
(function() {
    ...
    ---------------------------------*/
        function changeContactNo() {
            var contactButton = $('.ui-block-c  .btn-contactus');
                contactButton.html('<a href="callto:08453006672">0845 300 6672</a>');
    ...
    ---------------------------------*/
            function rearrangePage() {
                var header = $('#header');
                header.append('<div class="pd2-headline"><span>Local Strength, National Service</span></div>');
    ...
    function quantityOptions() {
        ...
        function addSelectorRow(price, productCode, details, defaultQuantity) {
            ...
            $('.pd2-addto__button').click(function() {
                ...
                var mainCode = parseInt($("[id^='productCode_']").attr('id').replace('productCode_', '') ,10);
                var CSRF = $('#addToCartForm input[name="CSRFToken"]').val();
                                ...
                                '<div class="pd2-brandinglightbox">',
                                    ...
                                    '<div class="pd2-brandightbox-innercontent">',
                                            ...
                                            '<div class="pd2-brandTitletext">',
                                                ...
                                                '<p>Text about branding and what happens when you fill out this form</p>',
                                            '</div>',
