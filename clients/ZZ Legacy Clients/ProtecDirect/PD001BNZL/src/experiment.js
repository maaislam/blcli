...
(function() {
    ...
    function run() {
        ...
        var menu = $([
            '<div class="pd1_navigation">',
                '<div class="pd1_navigation__item">',
                    '<a href="/Washroom~c~BCHSA" title="Washroom" class="">Washroom</a></div>',
                '<div class="pd1_navigation__item">',
                    '<a href="/Cleaning-Chemicals~c~BCHSB" title="Cleaning Chemicals" class="">Cleaning Chemicals</a></div>',
                '<div class="pd1_navigation__item">',
                    '<a href="/Wiping~c~BCHSC" title="Wiping" class="">Wiping</a></div>',
                '<div class="pd1_navigation__item">',
                    '<a href="/Janitorial~c~BCHSD" title="Janitorial Equipment" class="">Janitorial Equipment</a></div>',
                '<div class="pd1_navigation__item">',
                    '<a href="/Waste-Management~c~BCHSE" title="Waste Management" class="">Waste Management</a></div>',
                '<div class="pd1_navigation__item">',
                    '<a href="/Special-Offers~c~BCHSZ" title="Special Offers" class="">Special Offers</a></div>',
            '</div>'
        ].join(''));
        ...
        // -----------------------------------------------
            ...
            headerLinks.find('.ui-block-c .btn-contactus em').text('0121 326 8921');
