...
const PD006 = (() => {
	...
	const activate = () => {
		...
		var slides = [
      ['pd6-background1', 'https://www.protecdirect.co.uk/All-Discounts/Special-Offers~c~special_offers', 'https://d191y0yd6d0jy4.cloudfront.net/7xkkznk4kzk8reu.jpg'],
      ['pd6-background2', 'https://www.protecdirect.co.uk/All-Discounts/Special-Offers~c~special_offers', 'https://d191y0yd6d0jy4.cloudfront.net/5d0qw7i20wrflam.jpg']
    ];
        ...
        imgsrc = this[2];
			...
			$(['<li class="pd6-slide ' + name + '"><a href="' + link + '"><img src="' + imgsrc + '" /></a></li>'].join('')).appendTo('.pd6-slider');
		});
