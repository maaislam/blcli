...
export default () => {
  ...
  swapImages(".prd-ProductImage_Thumbnail", 0, 4);
  swapImages(".prd-Product_Image-desktop .prd-ProductImage_Slide", 0, 4);
  swapImages(".prd-Product_Image-mobile .prd-ProductImage_Slide", 0, 4);
