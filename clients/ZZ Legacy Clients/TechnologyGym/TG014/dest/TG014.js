    ...
    function activate() {
        ...
        function wholeExperiment() {
            ...
            if (window.location.href.indexOf('technogym.com/it/') > -1) { // italy version
                ...
                var textLinks = ['PRODOTTI', 'PRIVATE HOME', 'FITNESS CENTER', 'HOTEL', 'RESIDENCE',
                ...
                // Modify 'SOLUTIONS' section to display text links rather than image links
                ...
                // ---------------------------------------------------------------------------------------------------------
                // Fix some things with the 'SOLUTIONS' tab section
                ...
                var $productCategoryListItems = $('#ct-menu-top_menu').find('.inside > ul > li');
                // Array containing the text links
                var textLinks = ['PRODUCTS', 'PRIVATE HOME', 'FITNESS FACILITIES', 'HOSPITALITY', 'RESIDENTIAL',
                ...
                productsSubCategories(2, 'PRODUCT LINE');
                productsSubCategories(1, 'WORKOUT');
                productsSubCategories(0, 'CATEGORIES');
                ...
                // Add a 'view all' button to the (products -> categories subsection)
                var $viewAllButton = $('<div class="TG014_viewAll_wrapper"><a href="https://www.technogym.com/gb/products.html"><button class="TG014_viewAll">VIEW ALL</button></a></div>');
                $viewAllButton.appendTo('.TG014_children_PRODUCTS .level-0.tab-content li:eq(0) > .children');

                // Modify 'PRODUCTS -> WORKOUT' subsection to display text links rather than image links
                // Array containing the workout text links
                var workoutTextLinks = ['CARDIO', 'STRENGTH', 'FUNCTIONAL & FLEXIBILITY', 'GROUP ACTIVITIES'];
                var $workoutSection = $('.TG014_children_PRODUCTS .level-0.tab-content > li:eq(1)');
                var $itemsWorkoutSection = $workoutSection.find('.children > .level-1 > li');
                $itemsWorkoutSection.each(function (i) {
                    var $thisWorkoutItem = $(this);
                ...
                // Modify 'SOLUTIONS' section to display text links rather than image links
                var solutionTextLinks = ['PREMIUM SOLUTIONS', 'PRESTIGE SOLUTIONS'];
                // var $solutionSection = $('.TG014_children_PRODUCTS .level-0.tab-content > li:eq(1)');
                var $itemsSolutionSection = $('#ct-menu-top_menu').find('.inside > ul > li:eq(2) > .children > .level-0.tab-content .level-1 > li:not(:eq(1))');
                //  var $itemsSolutionSection = $solutionSection.find('.children > .level-1 > li');
                $itemsSolutionSection.each(function (i) {
                ...
                $solutionsSection.after([
                    '<li class="TG014_business_sectors"><span class="TG014_business_outter_header">BUSINESS SECTORS</span>',
                    '<ul class="TG014_business_sectors_inside">',
                    '<li class="TG014_insideSector TG014_hospitality_sector"><span class="TG014_business_inner_header">HOSPITALITY</span>',
                    '<div class="TG014_subsector_children">',
                    '<a href="https://www.technogym.com/gb/business-solution/hotels-cruise-liners/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Hotel</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/hotels-cruise-liners/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Cruises</p></a>',
                    '</div>',
                    '</li>',
                    '<li class="TG014_insideSector TG014_residential_sector"><span class="TG014_business_inner_header">RESIDENTIAL</span>',
                    '<div class="TG014_subsector_children">',
                    '<a href="https://www.technogym.com/gb/business-solution/residential/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Wellness Facilities</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/residential/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Wellness Rooms</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/residential/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">In-home Wellness</p></a>',
                    '</div>',
                    '</li>',
                    '<li class="TG014_insideSector TG014_health_sector"><span class="TG014_business_inner_header">HEALTH</span>',
                    '<div class="TG014_subsector_children">',
                    '<a href="https://www.technogym.com/gb/business-solution/metabolic-disorders/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Treatment of metabolic disorders</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/cardio-respiratory-disorders/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Cardio - respiratory rehabilitation</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/orthopedic-disorders/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Functional assessment</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/sports-medicine/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Sports Medicine</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/aging/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Quality ageing</p></a>',
                    '</div>',
                    '</li>',
                    '<li class="TG014_insideSector TG014_corporate_sector"><span class="TG014_business_inner_header">CORPORATE</span>',
                    '<div class="TG014_subsector_children">',
                    '<a href="https://www.technogym.com/gb/business-solution/no-space/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">No Space Solution</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/space/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Space Solution</p></a>',
                    '</div>',
                    '</li>',
                    '<li class="TG014_insideSector TG014_performance_sector"><span class="TG014_business_inner_header">PERFORMANCE</span>',
                    '<div class="TG014_subsector_children">',
                    '<a href="https://www.technogym.com/gb/who-we-are/partnership/#sports" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Sport Teams</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/universities/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Schools and Universities</p></a>',
                    '<a href="https://www.technogym.com/gb/business-solution/military/" class="TG014_subsector_linkChild"><p class="TG014_subsector_child">Armed Forces</p></a>',
                    '</div>',
                    '</li>',
                    '</ul>',
                    '</li>'
                ...
                $('#navtop-menu li:eq(0)').after('<li class="TG014_newsroom"><a href="https://www.technogym.com/gb/newsroom-home"><span>NEWSROOM</span></a></li>');
