...
export default () => {
  ...
  let cutoffDate = tempDate.setHours(19,0,0,0);

  // const deliveryDay = document.querySelector(`.${ID}-delivery_date`);
  // MONDAY 
    // before 3
    if(today.getDay() === 1 && today.getHours() < 19) {
    } 
    // after 3
    else if(today.getDay() === 1 && today.getHours() >= 19) {
  ...
    } 
    // after 3
    else if(today.getDay() === 2 && today.getHours() >= 19) {
  ...
    if(today.getDay() === 3 && today.getHours() < 19) {
      // deliveryDay.textContent = 'Thursday';
    } 
    // if wednesday after 3, set delivery to wednesday
    else if(today.getDay() === 3 && today.getHours() >= 19) {
...
   // If friday before 3pm, make it saturday
  ...
    if(today.getDay() === 0 && today.getHours() < 19) {
      cutoffDate = cutoffDate;
     // deliveryDay.textContent = 'Monday';
    }
    // if sunday after 3pm
    else if(today.getDay() === 0 && today.getHours() >= 19) {
      cutoffDate = cutoffDate + (1 * 86400000);
     // deliveryDay.textContent = 'Tuesday';
    }

  countdown({
    element: '.EJ048-countdown',
    cutoff: cutoffDate,
