...
export default () => {
  ...
  if(VARIATION !== 'control') {
    ...
    <div class="${ID}-delivery-banner">
      <div class="${ID}-container">
        <span></span><p>We have temporarily suspended using Royal Mail, order with confidence before 7pm for <b>Next Day delivery</b></p>
      </div>
    </div>`;

    if(getSiteFromHostname() === 'hsamuel') {
      document.querySelector('#access-content').insertAdjacentHTML('afterbegin', deliveryBanner);
    } else {
      document.querySelector('#access-content').insertAdjacentHTML('beforebegin', deliveryBanner);
    }
