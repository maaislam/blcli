...
export default class ProductReviews {
    ...
    create() {
        ...
        if(getSiteFromHostname() === 'hsamuel') {
            reviews = document.querySelector('#skip_link-reviews')
        } else {
            reviews = document.querySelector('#skip_link-reviews').nextElementSibling;
        }
    ...
    render() {
      ...
      document.querySelector(`.${ID}__origin`).insertAdjacentElement('afterend', component);
      ...
      // review changes
        ...
        const addReviewButton = () => {
            ...
            reviewButton.innerHTML = 'See product reviews';
