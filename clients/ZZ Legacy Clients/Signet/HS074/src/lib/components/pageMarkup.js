...
export default class PageContent {
    ...
    create() {
        ...
        // get the spec image
        let specImage;
        const thirdImage = document.querySelectorAll(`.product-gallery__image-container img`)[1];
        if(thirdImage) {
        ...
        element.innerHTML =
            ...
            <div class="${ID}__section ${ID}__fourcs">
                <div class="${ID}__sectionContainer">
                    ...
                    <div class="${ID}__paragraph">A diamond's 4 C's represent the four main components of its beauty and structure: Cut, Color, Clarity and Carat.</div>
