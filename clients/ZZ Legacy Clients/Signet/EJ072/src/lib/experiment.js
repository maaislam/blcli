...
export default () => {
  ...
  const recreateHeader = () => {
    ...
    if(document.querySelector('.browse-banner__content-inner p')) {
      pageDesc = document.querySelector('.browse-banner__content-inner p').textContent;
    }else if(document.querySelector('.seo-text-block__text-container p') && document.querySelector('.seo-text-block__text-container p').textContent.trim().match(/^(.*?)[.?!]\s/)[0]) {
      pageDesc = document.querySelector('.seo-text-block__text-container p').textContent.trim().match(/^(.*?)[.?!]\s/)[0];    
  ...
  const clickMoreFilters = () => {
    const filters = document.querySelector('.browse__filter-toggle-container .js-modal-trigger');
