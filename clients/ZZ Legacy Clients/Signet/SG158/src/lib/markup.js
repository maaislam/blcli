 ...
 export default class FinderBox {
   ...
   render() {
     ...
     if(window.location.href.indexOf('hsamuel.co.uk/?') > -1 || window.location.href === 'https://www.hsamuel.co.uk/') {
      document.querySelector('.SG204-contentspots-small').insertAdjacentElement('beforebegin', component);
     }  
     else if(window.location.href.indexOf('hsamuel.co.uk/christmas') > -1) {
      document.querySelector('.category-box-grid.category-box-grid--4-cards').insertAdjacentElement('afterend', component);
     }
     else if(window.location.href.indexOf('hsamuel.co.uk/gifts') > -1) {
      document.querySelector('.hero-banner--full-width').insertAdjacentElement('afterend', component);
     }      
