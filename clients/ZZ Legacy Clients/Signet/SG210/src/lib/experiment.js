...
import ProductFinder from './components/finder/finder';
...
export default () => {
  ...
  if(VARIATION !== 'control') {
    ...
    root.classList.add(`${ID}-finder-modal`);
    document.querySelector(config.elementToInsertAfter).insertAdjacentElement('afterend', root);
  
    render(<ProductFinder />, root);
  } else {
