...
export default () => {
  ...
  document.querySelector(".HS041-countdown").innerHTML = hours + "h " + minutes + "m " + seconds + "s ";
  ...
  offerMessage.classList.add('HS041-offer_banner');
  offerMessage.innerHTML = `<p class="HS041-message">${bannerMessage} - <span class="HS041-countdownText">Offer ends in <span class="HS041-countdown"></span></span></p>`;
