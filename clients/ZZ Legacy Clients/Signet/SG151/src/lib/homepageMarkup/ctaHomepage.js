...
import { getSiteFromHostname, mostViewedCategory } from "../helpers";
...
export default () => {
    ...
    const createMarkup = () => {
        ...
        <div class="${ID}-heroBanner">
            <div class="${ID}-left" style="background-image:url(${data.leftImage})"><a href="#"></a></div>
            <div class="${ID}-middle ${ID}-ctaWrap">
                <h3>Shop Our Categories</h3>
                <div class="${ID}-buttons"></div>
            </div>
            <div class="${ID}-right" style="background-image:url(${data.rightImage})"><a href="#"></a></div>
        </div>` : `
        <div class="${ID}-heroBanner">
