...
export default () => {
  ...
  const addTangibleeToSite = (d) => {
    ...
    s.src = "//cdn.tangiblee.com/integration/3.1/managed/www.hsamuel.co.uk/revision_1/variation_off/tangiblee-bundle.min.js";
    t.appendChild(s);
  };
...
          const requestText = temp.querySelector('body');
          if(requestText.textContent.trim() === 'true') {
            events.send('HS038-Control', 'Eligible Product');
