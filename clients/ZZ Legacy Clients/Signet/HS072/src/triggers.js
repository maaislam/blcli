...
if(document.location.href.indexOf('/webstore/l/') > -1) {
    pollerLite([
        'body',
    ...
    const observer = new MutationObserver(function(mutations) {
            mutations.forEach(function(mutation) {
                if (oldHref != document.location.href) {
                    ...
                    document.body.classList.remove('HS027');
                    if(document.querySelector('.HS072-filters-inner')) {
                        document.querySelector('.HS072-filters-inner').remove();
                    }
                    if(document.location.href.indexOf('/webstore/l/') > -1) {
                        pollerLite([
                            'body',
