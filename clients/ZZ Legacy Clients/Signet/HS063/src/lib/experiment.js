...
export default () => {
  ...
  offerMessage.innerHTML = `<p class="${ID}-message">Up to 25% off full priced Engagement Rings*. <span class="${ID}-countdownText">Ends in: <span class="${ID}-countdown"></span></span></p>`;
