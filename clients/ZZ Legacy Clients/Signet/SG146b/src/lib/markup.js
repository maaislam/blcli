...
`<div class="live-chat__chat-options-container ${ID}-liveChatOptions">
    ...
    <div class="${ID}-options">  
        ...
        <div class="${ID}-box ${ID}-liveChat live-chat__chat-option ${VARIATION === '2' || VARIATION === '3' ? `${ID}-boxShow` : ''}" opt-target="existing, repair, service, policy">
            <div class="live-chat__content"> 
        ...
        <div class="${ID}-box ${ID}-inStoreAppt live-chat__chat-option ${VARIATION === '1' || VARIATION === '3' ? `${ID}-boxShow` : ''}" opt-target="store, appointment, service, prepurchase">
             <div class="live-chat__content"> 
