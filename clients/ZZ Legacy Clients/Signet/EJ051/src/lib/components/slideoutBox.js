    ...
    const slideOutMarkup = {
        return: {
            ...
            <div class="${ID}-customerService">
                <div class="${ID}-icon"></div><div class="${ID}-serviceText"><p>Customer Service</p><a href="tel:0800 458 1066">0800 458 1066</a></div>
            </div>
            <a href="/refunds/?icid=ej-fn-ess-returns">More returns information</a>`,
        },
        delivery: {
            icon: '',
            title: 'Delivery Options',
            innerMarkup: 
            `<p><p class="${ID}-boldText">Free Click & Collect</p> to any Ernest Jones Store (excluding Eire or the Channel Islands).</p>
            ...
            <a href="/delivery-information/?icid=ej-fn-ess-delivery">Click here for more delivery information</a>`,
        },
        exchange: {
            icon: '',
            title: 'Free Exchange',
            ...
            <br>
            <p>Take it to a UK store of your choice together with your dispatch note. Orders via the website cannot be returned to stores in Eire or the Channel Islands.</p>
            <br>
            ...
            <a href="/refunds/?icid=ej-fn-ess-returns">Click here for more exchange information</a>`,
        },
    }
