...
export default () => {
    ...
    const changePaypalButton = () => {
        ...
        if(currentPaypalButton) {
            ...
            pollerLite(['#lower-button-group .basket__cta-form--paypal'], () => {
    ...
    const paypalCheckout = () => {
        ...
        // click paypal credit
        const currentCreditButton = document.querySelector('#lower-button-group .basket__cta-form--paypal-credit');
