      ...
      element.innerHTML = `
            ...
            <div class="${ID}-logo">
              <div class="header__logo"> 
                <a class="logo__link" href="/"> 
                  <img class="logo__img" src="//d113iaclfvkn13.cloudfront.net/logos/territorial-logo--hs-black.svg" alt="H.Samuel logo" width="130" height="17">
                </a>
              </div>
            </div>
        ...
        <div class="${ID}-trending">
          <div class="${ID}-container">
            <h3 class="headerThree">Trending</h3>
