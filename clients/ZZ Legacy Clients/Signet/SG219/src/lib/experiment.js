...
export default () => {
  ...
  if(VARIATION !== 'control') {
   ...
   const createBadge = (el) => {
    ...
    badge.innerHTML = `<span>25% OFF*</span>`;
    el.appendChild(badge);
    el.querySelector('.product-price').insertAdjacentHTML('beforebegin', `<span class="SG219-additionalInfo">*Use Code JEWEL25 at basket</span>`);
   }
   ...
   const removeBadge = () => {
    ...
    const allText = document.querySelectorAll(`.SG219-additionalInfo`);
