...
export default class ProductUSPs {
  ...
  create() {
    ...
    const exclusiveBrands = ['Vera Wang Love','Arctic Light','Le Vian','Leo Diamond','Neil Lane','Tolkowsky'];
    ...
    if(shared.VARIATION === '1') {
      returnOrCollect = {
        ...
        content: 'Return or exchange online or in-store within 30 days if your ring isn’t right'
      }
    ...
    const exclusiveUsps = {
        delivery: {
          ...
          content: `Tracked, discreet delivery on ` + actualDate + ` when you order in <span class="${ID}-countdown"></span>`,
        },
        moneyOff: {
          ...
          content: `You’ll only find ${brandName} at Ernest Jones`,
        },
        returnOrCollect,
    }
    ...
    const below500 = {
      delivery: {
        title: 'Free Delivery.',
        icon: 'https://service.maxymiser.net/cm/images-us/1/1/2/E2EED08A0505D5E2964F04E4BB438A800D5F014C2F3E23CED1251537DFBE8396/ernestjones-co-uk/EJ034---PDP-Service-Messaging---Prestige-Watches/noun_ExpressDelivery_1559182.png',
        content: `This product is eligible for free, discreet delivery `,
      },
      moneyOff: {
        title: `Save 10%.`,
        icon: 'https://service.maxymiser.net/cm/images-us/1/1/2/5BA53296368F77DA94FF6A6AD2600C7897EB2AA97DCE2548EC941B552FB8F8F8/ernestjones-co-uk/EJ034---PDP-Service-Messaging---Prestige-Watches/noun_warranty_85329.png',
    ...
    if (productPrice < 500) {
        uspToUse = below500;
    } else if(brandName && exclusiveBrands.indexOf(brandName) > -1) {
        uspToUse = exclusiveUsps;
