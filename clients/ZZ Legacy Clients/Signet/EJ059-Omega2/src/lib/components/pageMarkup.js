    ...
    create() {
        ...
        element.innerHTML =
            ...
            <div class="${ID}__section ${ID}__back_front">
                ...
                ${brand === 'Breitling' || brand === 'TAG Heuer' ? `
                <div class="${ID}-video">
                    <video width="500" height="500" controls>
                        <source src="${productObj.video}.mp4"  type="video/mp4"/>
                        <source src="${productObj.video}.webm"  type="video/webm"/>
                    </video>
                </div>`: 
                `<div class="${ID}__sectionCarousel">
                <div class="swiper-container">
                 <div class="swiper-slide ${ID}__slide" style="background-image:url(${productObj.section2Image1})"></div> 
                </div>
                </div>`}
