...
import CompareProducts from './comparisonTable';
...
export default () => {
  ...
  if(VARIATION !== 'control') {
    ...
    if(window.digitalData.page.pageInfo.pageType === 'PDP' ) {
      pollerLite(['#syte-similar-items-container'], () => {
        document.querySelector('.detail-page__container').appendChild(document.querySelector('#syte-similar-items-container'));
      });
    }
