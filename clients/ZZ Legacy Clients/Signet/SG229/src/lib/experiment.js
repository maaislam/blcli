...
export default () => {
  ...
  if(VARIATION !== 'control') {
    ...
    const addOfferMessage = () => {
      ...
      <p>Our best price guaranteed diamond rings and jewellery are stunning examples of our very best in quality and value so you can shop and enjoy with confidence. <a href="https://www.ernestjones.co.uk/terms/?icid=ej-fn-ess-terms#BestPriceGuarantee" target="_blank">Learn More</a></p>`
