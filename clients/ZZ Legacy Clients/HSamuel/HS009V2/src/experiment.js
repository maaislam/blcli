...
const checkErrorPage = () => {
  if (document.querySelector('h1').textContent.toLowerCase().indexOf('not found') > -1 && localStorage.getItem('HS009')) {
    events.send('HS009', 'Failed Search', 'Variation 2 - ' + localStorage.getItem('HS009'), { sendOnce: true });
...
const Run = () => {
  ...
  const Exp = {
    ...
    bindings: {
      ...
      findWatch() {
        const { cache } = Exp;
        const findWatchBtn =  Exp.cache.modal.querySelector('.HS009_find-watch');
        ...
        findWatchBtn.addEventListener('click', () => {
          ...
          const selectPerson = cache.bodyVar.querySelector('.HS009_person select').options[cache.bodyVar.querySelector('.HS009_person select').selectedIndex];
          const selectStrap = cache.bodyVar.querySelector('.HS009_strap select').options[cache.bodyVar.querySelector('.HS009_strap select').selectedIndex];
          const selectColor = cache.bodyVar.querySelector('.HS009_color select').options[cache.bodyVar.querySelector('.HS009_color select').selectedIndex];
          ...
          if (selectColorValue) {
            if (selectPersonText === 'Her') {
              if (selectColorValue === "business") {
                selectColorValue = 'brand%7Caccurist%7Canne+klein%7Cbulova%7Ccalvin+klein%7Ccitizen%7Ccluse%7Cdaisy+dixon%7Cdaniel+wellington%7Cdkny%7Cdreyfuss+%26+co%7Cfiorelli%7Cfossil%7Cgc%7Cguess%7Clipsy%7Clorus%7Cmondaine%7Cpulsar%7Croamer%7Crosefield%7Csekonda%7Cskagen%7Ctommy+hilfiger%7Cvictorinox%7Cwenger/';
              } else if (selectColorValue === "formal") {
                selectColorValue = 'brand%7Caccurist%7Canne+klein%7Ccalvin+klein%7Ccitizen%7Ccluse%7Cdaniel+wellington%7Cdreyfuss+%26+co%7Cgc%7Cguess%7Cmondaine%7Croamer%7Crosefield%7Csekonda%7Cskagen%7Cvictorinox%7Cjuicy+couture%7Cseiko/';
              } else if (selectColorValue === "sport") {
                selectColorValue = 'brand%7Cbaby-g%7Cbulova%7Ccasio%7Cgarmin%7Cg-shock%7Chuawei%7Clacoste%7Cpulsar%7Cseiko%7Cskagen%7Ctommy+hilfiger/';
              } else if (selectColorValue === "everyday") {
                selectColorValue = 'brand%7Carmani+exchange%7Ccalvin+klein%7Ccasio%7Ccath+kidston%7Ccluse%7Cdaisy+dixon%7Cdaniel+wellington%7Cdiesel%7Cdkny%7Cfiorelli%7Cfossil%7Cjuicy+couture%7Clacoste%7Climit%7Clipsy%7Clorus%7Cradley%7Crosefield%7Crotary%7Cseiko%7Csekonda%7Cseksy%7Cskagen%7Ctimex%7Ctommy+hilfiger%7Cversus+versace%7Cwenger/';
              }
            } else if (selectPersonText === 'Him') {
              if (selectColorValue === "business") {
                selectColorValue = 'brand%7Caccurist%7Cbulova%7Ccalvin+klein%7Ccitizen%7Cdaniel+wellington%7Cdreyfuss+%26+co%7Cfossil%7Cgc%7Cguess%7Clorus%7Cpulsar%7Crelic%7Croamer%7Csekonda%7Cskagen%7Ctommy+hilfiger%7Cvictorinox%7Cwenger/';
              } else if (selectColorValue === "formal") {
                selectColorValue = 'brand%7Caccurist%7Ccalvin+klein%7Ccitizen%7Cdaniel+wellington%7Cdreyfuss+%26+co%7Cgc%7Cguess%7Crelic%7Croamer%7Csekonda%7Cskagen%7Cvictorinox%7Cseiko/';
              } else if (selectColorValue === "sport") {
                selectColorValue = 'brand%7Cavi-8%7Cbulova%7Ccasio%7Cedifice%7Cgarmin%7Cg-shock%7Chuawei%7Clacoste%7Cmisfit%7Cpolice%7Cpulsar%7Cseiko%7Cskagen%7Ctommy+hilfiger/';
              } else if (selectColorValue === "everyday") {
                selectColorValue = 'brand%7Carmani+exchange%7Chugo%7Cavi-8%7Ccalvin+klein%7Ccasio%7Cdaniel+wellington%7Cdiesel%7Cedifice%7Cfossil%7Clacoste%7Climit%7Clorus%7Cpolice%7Crotary%7Cseiko%7Csekonda%7Cskagen%7Ctimex%7Ctommy+hilfiger%7Cversus+versace%7Cwenger/';
              }
            } else {
              if (selectColorValue === "business") {
                selectColorValue = 'brand%7Caccurist%7Canne+klein%7Cbulova%7Ccalvin+klein%7Ccitizen%7Ccluse%7Cdaisy+dixon%7Cdaniel+wellington%7Cdkny%7Cdreyfuss+%26+co%7Cfiorelli%7Cfossil%7Cgc%7Cguess%7Clipsy%7Clorus%7Cmondaine%7Cpulsar%7Crelic%7Croamer%7Crosefield%7Csekonda%7Cskagen%7Ctommy+hilfiger%7Cvictorinox%7Cwenger/';
              } else if (selectColorValue === "formal") {
                selectColorValue = 'brand%7Caccurist%7Canne+klein%7Ccalvin+klein%7Ccitizen%7Ccluse%7Cdaniel+wellington%7Cdreyfuss+%26+co%7Cgc%7Cguess%7Cmondaine%7Crelic%7Croamer%7Crosefield%7Csekonda%7Cskagen%7Cvictorinox%7Cjuicy+couture%7Cseiko/';
              } else if (selectColorValue === "sport") {
                selectColorValue = 'brand%7Cavi-8%7Cbaby-g%7Cbulova%7Ccasio%7Cedifice%7Cgarmin%7Cg-shock%7Chuawei%7Clacoste%7Cmisfit%7Cpolice%7Cpulsar%7Cseiko%7Cskagen%7Ctommy+hilfiger/';
              } else if (selectColorValue === "everyday") {
                selectColorValue = 'brand%7Carmani+exchange%7Cavi-8%7Chugo%7Ccalvin+klein%7Ccasio%7Ccath+kidston%7Ccluse%7Cdaisy+dixon%7Cdaniel+wellington%7Cdiesel%7Cdkny%7Cedifice%7Cfiorelli%7Cfossil%7Cjuicy+couture%7Clacoste%7Climit%7Clipsy%7Clorus%7Cpolice%7Cradley%7Crosefield%7Crotary%7Cseiko%7Csekonda%7Cseksy%7Cskagen%7Ctimex%7Ctommy+hilfiger%7Cversus+versace%7Cwenger/';
              }
            } 
          } else {
            selectColorValue = '';
          ...
          // events.send(`${Exp.settings.ID}`, 'Watch Search', `For: ${selectPersonText}, Strap: ${selectStrapText}, Occasion: ${selectColorText}, Price From: ${priceFrom}, Price To: ${priceTo}`, { sendOnce: true });
