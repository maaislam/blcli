...
const activate = () => {
  ...
  const newHeaderComponent = componentFactory({
    ...
    create: () => {
      ...
      html += `<div class="${ID}_col-4 ${ID}_align--middle"><div class="${ID}_Header__link"><a href="https://www.hsamuel.co.uk/">Continue Shopping</a></div></div>`;
      html += `<div class="${ID}_col-4 ${ID}_align--right"><div class="${ID}_Header__info"><div>Call us on 0800 458 1065</div><div class="${ID}_small">9am - 5:30pm Monday to Friday, 9am - 1:00pm Saturdays</div></div></div>`;
    ...
    create: () => {
      ...
      const giftPackagingElement = (() => {
        ...
        if (giftPackagingAdded) {
          ...
          element.innerText = '+ Add gift packaging for £2.95';
  ...
  const paymentComponent = componentFactory({
    ...
    create: () => {
      ...
      const isFinance = !!cacheDom.get('#ifcPaymentPlan');
      const financeAvailable = !!cacheDom.get('.js-ifcBuyButton');
          ...
          html = [
            `<div class="${ID}_Payment__option ${ID}_Payment__option--disabled" id="${ID}_Payment__option--finance">`,
              `<div class="${ID}_Payment__option__message">`,
                `<p>Unfortunately your order isn't eligible for finance. For more information please see our <a target="_blank" class="${ID}_Payment__option--blockSelect" href="/webstore/static/customerservice/shopping/interestFreeCredit.cdo">Terms and Conditions</a></p>`,
              '</div>',
              `<input type="radio" id="${ID}_Payment__input--finance" name="${ID}_finance" />`,
              `<label for="${ID}_finance">Pay in 0% APR interest free monthly instalments</label>`,
              `<div class="${ID}_Payment__desc">From just 10% deposit, maximum 48 months 0% APR interest free</div>`,
    ...
    events: (component) => {
      ...
      const originalFinanceConfirmCTA = cacheDom.get('.cta--basket.cta--primary', true);
  ...
  const DXLogoComponent = componentFactory({
    create: () => {
      ...
      element.innerHTML = `<div class="${ID}_DX__logo"><img src="https://ab-test-sandbox.userconversion.com/experiments/HS013-dx_logo.png"/></div><div class="${ID}_DX__usps"></div>`;
      ...
      const html = [
        ...
        `<div class="${ID}_lightbox-inner">`,
          ...
          `<div class="${ID}_lightbox-slide">`,
            `<div class="${ID}_lightbox-image"><img src="https://ab-test-sandbox.userconversion.com/experiments/HS013-Lightbox_1.png"/></div>`,
            `<div class="${ID}_lightbox-image"><img src="https://ab-test-sandbox.userconversion.com/experiments/HS013-Lightbox_2.png"/></div>`,
            `<div class="${ID}_lightbox-image"><img src="https://ab-test-sandbox.userconversion.com/experiments/HS013-Lightbox_3.png"/></div>`,
          '</div>',
  ...
  const footerComponent = componentFactory({
    create: () => {
      ...
      <div class="${ID}_footer-inner">
        <span class="${ID}_copyright">©Signet Trading Limited 2018. All rights reserved. H.Samuel and Helps you say it better are trade marks of Signet or its licensors.</span>
