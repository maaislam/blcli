...
export default () => {
  ...
  const stepsBar = () => {
    ...
    if (document.querySelector('#ifcPaymentContainer')) {
      ...
      <div class="${id}-finance_Step"><span>2</span><p>Your details</p></div>
      <div class="${id}-finance_Step"><span>3</span><p>Credit Application</p></div>
      <div class="${id}-finance_Step"><span>4</span><p>Success</p></div>`;
    } else {
      stepBarWrapper.innerHTML = `
      <div class="${id}-finance_Step"><span>1</span><p>Basket</p></div>
