    ...
    components: {
      render() {
        ...
        const ingridCountdown = [
          '<div class="HS_container container HS_yellow-theme">',
            '<div class="HS_countdown-ingrid">',
              '<h2>Black Friday Half <br class="HS_mobile-breakpoint" />Price <strong>Event</strong></h2>',
              '<span class="HS_small-text">Prices online are at a 10% discount</span>',
              '<div class="clock_wrap">',
                '<div class="clock_time-block">',
                  '<span class="days"></span>',
                  '<div class="time-info">days</div>',
