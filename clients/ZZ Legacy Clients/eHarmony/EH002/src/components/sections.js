  ...
  const howItWorks = () => {
    const steps = {
      ...
      3: {
        ...
        text: 'Review the profiles of everyone who we\'ve determined to be a right for you, for FREE',
      },
      4: {
        image: '//cdn.optimizely.com/img/8361134338/35451b314df14b5a96ff4410d683b938.png',
        text: 'Pick a plan that fits your needs and start communicating at your own pace.',
      },
    };
