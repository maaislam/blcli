export const formContent = {
  questions_EN: [
    ...
    {
      title: 'Thanks [name], please provide your email address',
    ...
    {
      title: 'Would you also like to provide a phone number?',
    ...
    {
      title: 'Thanks [name], please provide the best number to contact you on',
    },
  ],
  text_EN: [
    'Request a Callback',
  ...
  questions_IT: [
    ...
    {
      title: 'Grazie [name], puoi fornirci il tuo indirizzo email?',
      ...
      formFields: [
        ...
        },
        {
          ...
          <div class="TG063_tab-form__inputSelectWrap">
            <select class="TG063_tab-form__inputSelect use--mail" required>
              <option value="" disabled selected>---</option>
              <option value="private_individual">Uso Casalingo</option>
              <option value="business">Uso Commerciale</option>
              <option value="freelance_professional">Freelance, Professionista</option>
            </select>
          </div>
