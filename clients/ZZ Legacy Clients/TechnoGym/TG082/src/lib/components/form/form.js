...
export default class Form {
  ...
  bindEvents() {
    ...
    const formCheckbox = document.querySelector('.checkbox #agree');
  ...
  render() {
    ...
    const belowFold = document.querySelector('.tg10-productInfo');
    
    window.onscroll = () => {
      const navOffset = (belowFold.getBoundingClientRect().y + window.scrollY) + 200;
