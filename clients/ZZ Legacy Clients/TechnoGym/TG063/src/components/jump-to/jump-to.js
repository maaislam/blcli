...
export default class JumpTo {
  ...
  render() {
    document.querySelector(`.${ID}_contact-page .forms`).insertAdjacentElement('beforebegin', this.component);
    document.querySelector(`.${ID}_contact-page .forms`).id = 'contact-form';
  }
}
