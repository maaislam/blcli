...
export default () => {
  ...
  `<div class="TG103-container">
    ...
    <div class="TG103-cta">
      <div class="TG103-secondary_button TG103-button"><a class="TG103-request" target="_blank" href="https://www.technogym.com/gb/contacts/?reason=catalogue&sku=MYRUN-CONFIGURABLE-EUROPE&type=conf">${__('Catalogue')}</a></div>
      <div class="TG103-primary_button TG103-button"><a href="#TG103-mainProduct">${__('Buy')}</a></div>
    </div>
  </div>`;
  ...
  const linkSlider = () => {
    jQuery.getScript('https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.js', (data, textStatus, jqxhr) => {
      jQuery('.TG103-container ul').slick({
        infinite: true,
        slidesToShow: 3,
        adaptiveHeight: true,
        arrows: true,
