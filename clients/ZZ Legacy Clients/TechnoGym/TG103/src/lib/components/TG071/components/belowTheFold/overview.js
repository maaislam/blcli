...
export default () => {
   ...
   */
  const overviewContainer = document.querySelector('#TG103-overview');

  const images = [
    '//cdn.optimizely.com/img/8355110909/55ee88ec560d4628b0fc9f27d8b6f190.png',
    ...
    '//cdn.optimizely.com/img/8355110909/938a89db26b74275bff5732026de07e5.png',
  ];
  ...
  <div class="TG103-grid_images">
    <div class="TG103-grid_column"></div>
    <div class="TG103-grid_column"></div>
    <div class="TG103-grid_column"></div>
    <div class="TG103-grid_column"></div>  
  </div>`;
  ...
  const cols = document.querySelectorAll('.TG103-grid_column');
  const createImage = (url) => {
    const gridImage = document.createElement('div');
    gridImage.classList.add('TG103-grid-image');
