...
export default () => {
  ...
  const productSlide = {
    gb: [
      ...
      {
        image1: '//cdn.optimizely.com/img/8355110909/1bf5c8ac6fb44dafa30de9892fd5dedd.jpg',
      ...
      {
        image1: '//cdn.optimizely.com/img/8355110909/352f5a69cb0841a8b6a0468e4d6c6422.jpg',
      ...
      {
        image1: '//cdn.optimizely.com/img/8355110909/ebe5f4b88e334f71a009cf8a16c88c80.jpg',
  ...
  productSlide[countryKey].forEach((ele) => {
    ...
    `<div class="${mainClass}${productLineLocal}">
      <div class="custom-product-slides"> 
        ...
        <div class="custom-product-slides">
          <div class="TG064-product_text-top">
            <h1>
          ...
          <div class="TG064-description">
            <p>
              ${ele.SmallDescription} 
              <span class="TG064-hidden_text">${ele.SmallDescriptionHidden}</span>
            </p>
            <span class="TG064-read_more"></span>
            </div>
        </div>
      </div>
     <a class="TG064-learn_more TG064-secondary_button TG064-button" href="${ele.link}">Learn More</a>
    </div>`;
  ...
  const needHelp = {
    gb: [
      `<div class="custom-needHelp">
        <p>Want some advice choosing your fitness equipment? <br></br>We are always happy to advise and support you. 
          <div class="TG064-button TG064-secondary_button">
            <a target="_blank"href="https://www.technogym.com/gb/contacts/">Get Advice</a>
          </div>
        </p>
      </div>`,
    ].join(''),
    us: [
      `<div class="custom-needHelp">
        <p>Want some advice choosing your fitness equipment? <br />We are always happy to advise and support you. <a href="https://www.technogym.com/us/contacts/">Click here</a></p>
      </div>`,
    ].join(''),
    int: [
      `<div class="custom-needHelp">
        <p>Want some advice choosing your fitness equipment? <br />We are always happy to advise and support you. <a href="https://www.technogym.com/int/contacts/">Click here</a></p>
      </div>`,
    ].join(''),
  };
  // ------------------ Two column right image Section content------------------------

  const improveWorkout = {
    gb: [
    ...
    us: [
      ...
      <h2>Improved Cardio Workouts</h2>
      Technogym treadmills utilise some of the latest production techniques to improve every part of your workout experience. 
      This includes the <a href="https://www.technogym.com/us/treadmill-excite-1000.html">Run 1000 Excite</a>, which features Fast Track Controls that allow you to easily adjust the speed and incline of your training without having to adjust your running posture. 
      The cushioned running surface automatically adapts to your running style, to ensure you get the best experience every time.<br>
      As well as improving workouts, our treadmills provide you with data from your training sessions to help you achieve your fitness goals, whether they are to tone up, lose weight or improve your overall level of fitness.`,
    ].join(''),
    int: [
      ...
      <h2>Improved Cardio Workouts</h2>
      Technogym treadmills utilise some of the latest production techniques to improve every part of your workout experience. 
      This includes the <a href="https://www.technogym.com/int/treadmill-excite-1000.html">Run 1000 Excite</a>, which features Fast Track Controls that allow you to easily adjust the speed and incline of your training without having to adjust your running posture. 
      The cushioned running surface automatically adapts to your running style, to ensure you get the best experience every time.<br>
      As well as improving workouts, our treadmills provide you with data from your training sessions to help you achieve your fitness goals, whether they are to tone up, lose weight or improve your overall level of fitness.`,
    ].join(''),
  };
  ...
  const wellnessTechnology = {
    ...
    us: [
      ...
      <h2>Fitness for Everyone</h2>
      You'll find treadmills for every application, including equipment that can help with the recovery of muscular injuries and equipment featuring our
      <a href="https://www.technogym.com/us/who-we-are/unity/">UNITY</a> systems, which include games that let you challenge friends to beat your performance to help you exercise and stay engaged while training.<p></p>`,
    ].join(''),
    int: [
      `<h2>Endlessly Adaptable Wellness Technology</h2>
      As with all Technogym products, our treadmills are endlessly adaptable, offering a professional-standard product whatever your needs and for whatever size requirements you may have, with delivery and expert
      ...
      <h2>Fitness for Everyone</h2>
      You'll find treadmills for every application, including equipment that can help with the recovery of muscular injuries and equipment featuring our
      <a href="https://www.technogym.com/int/who-we-are/unity/">UNITY</a> systems, which include games that let you challenge friends to beat your performance to help you exercise and stay engaged while training.<p></p>`,
    ].join(''),
  };
    ...
    gb: [
      `<div class="custom-two-column">
        ...
        <div class="custom-two-col-equal clearBoth">
          ...
          <div class="customColumn imageBackground">
            <img src="//cdn.optimizely.com/img/8355110909/78f5e686a70d4a46851655e0fe57625e.jpg">
          </div>
        </div>
        <div class="custom-two-col-equal clearBoth">
          <div class="customColumn imageBackground">
            <img src="//cdn-3.convertexperiments.com/uf/1002628/1002262/1521712417man.png">
          </div>
  ...
  const content = () => {
    ...
    const productLineBar = document.createElement('div');

    // add the product bar
    productLineBar.innerHTML = productLine[countryKey];
    containerTitle.insertAdjacentElement('afterend', productLineBar);

    // add the need help section
    const bottomBar = document.querySelector('.bottom-bar');
    const needHelpBar = document.createElement('div');
    needHelpBar.classList.add('TG064-need_help');
    needHelpBar.innerHTML = needHelp[countryKey];
    bottomBar.insertAdjacentElement('beforeBegin', needHelpBar);

    const helpBar = document.querySelector('.TG064-need_help');
    const aboutColumns = document.createElement('div');
    aboutColumns.classList.add('TG064-bottom_content');
  ...
  // show hide the product lines
  const productLines = document.querySelectorAll('.custom-product-line > .productLine a:not(.tg42-all)');
  for (let index = 0; index < productLines.length; index += 1) {
    const element = productLines[index];
    element.addEventListener('click', (e) => {
      ...
      const getLine = e.target.getAttribute('data-attr');

      [].forEach.call(document.querySelectorAll('.item-product'), (item) => {
        item.style.display = 'none';
      });
      [].forEach.call(document.querySelectorAll(`.${getLine}`), (match) => {
