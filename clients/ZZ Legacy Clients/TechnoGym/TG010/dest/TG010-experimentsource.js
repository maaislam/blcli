var _TG010 = (function () {
	...
	function TG010() {
		...
		if (pageurl === 'http://www.technogym.com/land/it/landing_myrun_adwords/?sfcampid=268940&gclid=EAIaIQobChMI_fGy4afd1QIVSWt-Ch069wd9EAAYASAAEgLFgPD_BwE') {
			pageCountry = 'italian';

		} else if (pageurl === 'http://www.technogym.com/land/en-us/landing_myrun_adwords/?sfcampid=268940&gclid=EAIaIQobChMI_fGy4afd1QIVSWt-Ch069wd9EAAYASAAEgLFgPD_BwE') {
			pageCountry = 'english';
		}
		...
		if (pageCountry === 'italian') {
			...
			productSubtext = 'Può essere tua a 85€ al mese. Tan 0%. Taeg 3.65%';
			smallProddesc = "MYRUN è un elegante, elegante, tapis roulant ad alte prestazioni che include anche un'applicazione nativa per monitorare e ottimizzare i tuoi allenamenti.",
				bulletPoint1 = 'italian here';
			bulletPoint2 = 'italian here';
			bulletPoint3 = 'italian here';


			getBrochure = 'italian here';
			getBrochureUSP = 'italian here';
			formFieldphone = 'Telfono';
			...
			block1heading = 'Italian here';
			block1text = 'Italian here';
			block2heading = 'MYRUN APP';
			block2text = 'MYRUN è il primo tapis roulant ad includere una app nativa per il tuo tablet. Con la MYRUN app puoi pianificare esercizi e sessioni di allenamento in base alle tue esigenze o ai tuoi obiettivi personali.';
			block3heading = 'Disegnato dai runner per chi ama correre';
			...
			getBrochure = 'GET YOUR BROCHURE';
			getBrochureUSP = 'to see the full MYRUN spec, and learn about every feature';
			...
			block2text = 'MYRUN seamlessly integrates a treadmill and native app that syncs to your tablet. The MYRUN app gives you personalised training programmes, real-time feedback and helps make training more fun and effective.';
		...
		topBar.html(['<div class="tg10-headerInner">',
			...
			'<div class="tg10-headerContent"><a class="tg10-headerButton" href="' + productURL + '">' + productView + '</a></div>',
			'</div>'
		].join(''));
		...
		function topContentMobile() {
			...
			if ($('.tg10-newContentmobile').length > 0) {
				var $topcontentTitle = 'TECHNOGYM<span>&reg;</span> MYRUN',
					...
					$topcontentPrice = '£3,250 including VAT, delivery and installation - no hidden costs',
				...
				$pageContent.html(['<div class="tg10-toptext">',
					...
					'<a href="' + $topcontentLink + '">' + productView + ' ></a>',
		...
		function topcontentDesktop() {
			...
			if ($('.tg10-newContentdesktop').length > 0) {
				...
				$pageContent.html(['<div class="tg10-toptext">',
					'<h3>' + $topcontentTitle + '</h3>',
					'<span class="tg10-subText">' + $topcontentSub + '</span>',
					'<span class="tg10-firstBlocktext">',
					$showtopText,
					'<div class="tg10-desktopBullets">',
					'<li>' + $tickImage + bulletPoint1 + '</li>',
					'</span>',
					'<span class="tg10-secondBlocktext">',
					'<li>' + $tickImage + bulletPoint2 + '</li>',
					'<li>' + $tickImage + bulletPoint3 + '</li>',
					'</div>',
					'</span>',
					//'<span class="tg10-more">Read more</span>',
					'</div>'
				].join(''));
				...
				$('.col-sm-9.text-center.tg10-topColumn').append('<div class="col-sm-9 tg10-desktopBanner tg10-background1"><div class="tg10-imagessideWrap"/></div>');
				...
				//findoutMore.find('img').attr('src','//cdn.optimizely.com/img/8355110909/8c7061eee97a4abeaf72fae8cecc58aa.jpg');
		...
		productInfoWrapper.insertAfter(uspInfo);
		...
		/*------------------------------
		  Footer 
		---------------------------------*/
		var footer = $('<div class="tg10-footerbox"/>').appendTo('.tg10-imagessideWrap');
