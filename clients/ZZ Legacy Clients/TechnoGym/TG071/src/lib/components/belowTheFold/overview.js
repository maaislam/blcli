...
export default () => {
   ...
   */
  const overviewContainer = document.querySelector('#TG071-overview');
  ...
  <div class="TG071-grid_images">
    <div class="TG071-grid_column"></div>
    <div class="TG071-grid_column"></div>
    <div class="TG071-grid_column"></div>
    <div class="TG071-grid_column"></div>  
  </div>`;
  ...
  const cols = document.querySelectorAll('.TG071-grid_column');
  const createImage = (url) => {
    const gridImage = document.createElement('div');
    gridImage.classList.add('TG071-grid-image');
