...
const AC018 = (() => {
	...
	function init(){
      ...
      let agencyResultsNum;
		...
		const searchBuilder = {
			...
			subIndustryClick(){
				const newSubSelect = $('.AC018_sub-industry select');
				const mainIndSelect = $('.AC018_industry select');

				newSubSelect.on('change', function(){
					var el = $(this),
						elOption = el.find('option:selected'),
						elData = elOption.val(),
            mainIndOption = mainIndSelect.find('option:selected').val();

					if(elOption.text() == 'Please select an Industry'){
					}
					else{
						$('#input-skill-selector-dropdown .dropdown-option[data-value="' + elData + '"]').click();
            if (elData == 'administration' && mainIndOption == 'admin'
            || elData == 'alladminsecretarialskills' && mainIndOption == 'admin'
            || elData == 'bilingual' && mainIndOption == 'admin'
            || elData == 'pa' && mainIndOption == 'admin'
            || elData == 'receiptionisttelephonist' && mainIndOption == 'admin'
            || elData == 'secretarial' && mainIndOption == 'admin'
            || elData == 'switchboard' && mainIndOption == 'admin'
            || elData == 'typist' && mainIndOption == 'admin'
            || elData == 'allagriculturalskills' && mainIndOption == 'agriculture'
            || elData == 'arboricultureforestry' && mainIndOption == 'agriculture'
            || elData == 'drivers' && mainIndOption == 'agriculture'
            || elData == 'farmlabour' && mainIndOption == 'agriculture'
            || elData == 'gisgeographicinformationsystems' && mainIndOption == 'agriculture'
            || elData == 'horticulture' && mainIndOption == 'agriculture'
            || elData == 'seasonalworkers' && mainIndOption == 'agriculture'
            || elData == 'all' && mainIndOption == 'catering'
            || elData == 'bars' && mainIndOption == 'catering'
            || elData == 'confbanq' && mainIndOption == 'catering'
            || elData == 'frontoffice' && mainIndOption == 'catering'
            || elData == 'hotel-staff' && mainIndOption == 'catering'
            || elData == 'housekeeping' && mainIndOption == 'catering'
            || elData == 'kitchen' && mainIndOption == 'catering'
            || elData == 'restaurant' && mainIndOption == 'catering'
            || elData == 'sales' && mainIndOption == 'catering'
            || elData == 'uksuppliersofinternationalworkers' && mainIndOption == 'catering'
            || elData == 'allconstructionskills' && mainIndOption == 'construction'
            || elData == 'buildingandcivilstrades' && mainIndOption == 'construction'
            || elData == 'buildingservicesmecontracting' && mainIndOption == 'construction'
            || elData == 'civilstradesandlabour' && mainIndOption == 'construction'
            || elData == 'commercialinteriors' && mainIndOption == 'construction'
            || elData == 'contracting' && mainIndOption == 'construction'
            || elData == 'mechanicalelectricaltradeslabour' && mainIndOption == 'construction'
            || elData == 'uksuppliersofinternationalworkers' && mainIndOption == 'construction'
            || elData == 'allcustomerservicecallcentreskills' && mainIndOption == 'custservcallcentre'
            || elData == 'businessservices' && mainIndOption == 'custservcallcentre'
            || elData == 'customer' && mainIndOption == 'custservcallcentre'
            || elData == 'languages' && mainIndOption == 'custservcallcentre'
            || elData == 'operational' && mainIndOption == 'custservcallcentre'
            || elData == 'technology' && mainIndOption == 'custservcallcentre'
            || elData == 'training' && mainIndOption == 'custservcallcentre'
            || elData == '75tonne' && mainIndOption == 'driving'
            || elData == 'agriculture' && mainIndOption == 'driving'
            || elData == 'alldrivingskills' && mainIndOption == 'driving'
            || elData == 'commercial' && mainIndOption == 'driving'
            || elData == 'courier' && mainIndOption == 'driving'
            || elData == 'distribution' && mainIndOption == 'driving'
            || elData == 'forklift' && mainIndOption == 'driving'
            || elData == 'instructors' && mainIndOption == 'driving'
            || elData == 'lgv' && mainIndOption == 'driving'
            || elData == 'plant' && mainIndOption == 'driving'
            || elData == 'uksuppliersofinternationalworkers' && mainIndOption == 'driving'
            || elData == 'inhousehardservices' && mainIndOption == 'facilitiesmanagement'
            || elData == 'inhousesoftservices' && mainIndOption == 'facilitiesmanagement'
            || elData == 'administration' && mainIndOption == 'fashion'
            || elData == 'retail' && mainIndOption == 'fashion'
            || elData == 'administration' && mainIndOption == 'financialservices'
            || elData == 'ancillaryhospitalstaff' && mainIndOption == 'health'
            || elData == 'generalpracticenonclinical' && mainIndOption == 'health'
            || elData == 'allindustrialskills' && mainIndOption == 'industrial'
            || elData == 'assemblers' && mainIndOption == 'industrial'
            || elData == 'cleaning' && mainIndOption == 'industrial'
            || elData == 'domestic' && mainIndOption == 'industrial'
            || elData == 'drilling' && mainIndOption == 'industrial'
            || elData == 'drivers' && mainIndOption == 'industrial'
            || elData == 'foodprocessing' && mainIndOption == 'industrial'
            || elData == 'forklift' && mainIndOption == 'industrial'
            || elData == 'gardening' && mainIndOption == 'industrial'
            || elData == 'injectionmoulding' && mainIndOption == 'industrial'
            || elData == 'jigging' && mainIndOption == 'industrial'
            || elData == 'loaders' && mainIndOption == 'industrial'
            || elData == 'lobouring' && mainIndOption == 'industrial'
            || elData == 'machineoperating' && mainIndOption == 'industrial'
            || elData == 'orderpickers' && mainIndOption == 'industrial'
            || elData == 'packers' && mainIndOption == 'industrial'
            || elData == 'painting' && mainIndOption == 'industrial'
            || elData == 'parcelsorters' && mainIndOption == 'industrial'
            || elData == 'portering' && mainIndOption == 'industrial'
            || elData == 'powdercoating' && mainIndOption == 'industrial'
            || elData == 'pressingproduction' && mainIndOption == 'industrial'
            || elData == 'productionline' && mainIndOption == 'industrial'
            || elData == 'refusecollection' && mainIndOption == 'industrial'
            || elData == 'soldering' && mainIndOption == 'industrial'
            || elData == 'tapping' && mainIndOption == 'industrial'
            || elData == 'typefitting' && mainIndOption == 'industrial'
            || elData == 'uksuppliersofinternationalworkers' && mainIndOption == 'industrial'
            || elData == 'warehouseoperatives' && mainIndOption == 'industrial'
            || elData == 'administration' && mainIndOption == 'industrial'
            || elData == 'all' && mainIndOption == 'retail'
            || elData == 'security' && mainIndOption == 'retail'
            || elData == 'uksuppliersofinternationalworkers' && mainIndOption == 'retail'
            ) {
              $('.AC018_order-by').addClass('AC022_hide-special').removeClass('AC022_hide-distance');
              console.log('test 1');
            } else {
              $('.AC018_order-by').addClass('AC022_hide-distance').removeClass('AC022_hide-special');
    ...
    function hideAgencies(){
      ...
      allAgencies.forEach((el, index) => {
        if(index > 2){
          const distanceBand = $(el).next();
          
          doc.querySelector('.AC022_exra-agencies').appendChild(el);
          if (distanceBand.hasClass('distance-bands-text')) {
            distanceBand.appendTo($('.AC022_exra-agencies'));
          }
        }
      });
      ...
      const CVLib = doc.querySelector('#search-results-container .candidate-assist-panel.row');
      const extraAgencies = doc.querySelector('.AC022_exra-agencies');
      if (CVLib) {
        extraAgencies.insertBefore(CVLib, extraAgencies.querySelector('.agency-result.row:first-child + .agency-result.row'));
      }
    }
