    ...
    const controlPopup = () => {
      ...
      if (popup) {
        closeBtn.addEventListener('click', function() {
          ...
          events.send('HD014', 'Exit Intent Closed', 'User has closed exit intent coupon');
        });
        // Continue shopping
      ...
      */
      ...
      onExit.init(function(){
        ...
        const appendPopup = () => {
          ...
          // event tracking
          events.send('HD014', 'Exit Intent shown', 'User has seen exit intent coupon');
        };
        appendPopup();  
        controlPopup();
    
      }, 'HD014_popupShown', 'hearingdirect.com');
        /* eslint-enable */
      // }
      /*
