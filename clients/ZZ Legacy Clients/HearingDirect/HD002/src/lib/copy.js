const copy = {
    'tooltip':  {
        'gb':   {
            'first': 'At Hearing Direct are always looking to price competitively. Remember all our products have:',
    ...
    'popup': {
        'gb':   {
            ...
            'listOne': 'Excellent range of high-quality digital hearing aids up to 90% cheaper than buying from the high street',
