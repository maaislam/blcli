...
export default () => {
  ...
  const buildNewNavBar = () => {
    ...
    document.getElementById('BodyWrap').insertAdjacentHTML('beforeend', `
      <section role="navigation" id="FLAN-55-navbar" class="FLAN-55-navbar">


        <div class="nav-section menu-section">
          <a href="#" id="trigger-menu" class="trigger-action menu">
            <svg class="menu-icon inactive-state" width="29px" height="18px" viewBox="0 0 29 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Proposed-Designs-04/11" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="square"><g id="message-tooltip" transform="translate(-63.000000, -571.000000)" stroke="#FFFFFF" stroke-width="1.6"><g id="Group-5" transform="translate(63.500000, 572.000000)"><line x1="0.608695652" y1="0.5" x2="27.3913043" y2="0.5" id="Line"></line><line x1="0.608695652" y1="15.5" x2="27.3913043" y2="15.5" id="Line"></line><line x1="0.608695652" y1="8" x2="27.3913043" y2="8" id="Line"></line></g></g></g></svg>
    ...
    newNavbar = document.getElementById('FLAN-55-navbar');
  ...
  const firstTimeMessage = () => {
    ...
    if(!getCookie('FLAN-55-message-initial')) {
      events.send(ID, `${shared.ID} Variation ${shared.VARIATION}`, `Displayed first time message`);
      body.classList.add('FLAN-55-noscroll');
      body.insertAdjacentHTML('beforeend', `

        <div id="FLAN-55-message" class="FLAN-55-message">
      ...
      `);
      const ftMessage = document.getElementById('FLAN-55-message');
