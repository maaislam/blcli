/**
 * FLAN-236 - Items in bag low in stock
 *
  ...
  pollerLite([
    ...
    () => {
      ...
      if (VARIATION == 'control') {
        ...
        let iterator = 0;
        [].slice.call(basketItems).forEach(function(basketItem) {

          let href = basketItem.querySelector('.productTitle').href;
          ...
          if(href != "") {
              ...
              setTimeout(function() {
                if(typeof res !== null) {
                  ...
                  if(stockQuant > 0 && stockQuant <= 10) {
                    ...
                    fireEvent(`Conditions Met - Reports stock quantity of 0 on SKU: ${productSKU}, experiment not shown`);
                  } else {
                    // if stock is 11+, don't show, remove any existing, and fire event
                    fireEvent(`Conditions Met - Reports stock quantity of over 11 on SKU: ${productSKU}, experiment not shown`);
                  }
                }
            ...
            fireEvent(`Conditions Met - Experiment not run on this product, zero stock displayed on site`)
          }
