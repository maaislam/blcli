  ...
  (function() {
    ...
    var customEvents = {
      ...
      secureContinue: function secureContinue() {
        var secureBtn = document.querySelector('.NewCustWrap a#dnn_ctr88149_Launch_btnGuestCustomer');
        if (secureBtn) {
    ...
    var observeMessage = function observeMessage(cb) {
      pollerLite(['#dnn_ctr88149_Launch_registerLogin_divLoginErrorMessage', '.FL015-account-options'], function () {
        var errorMessage = document.getElementById('dnn_ctr88149_Launch_registerLogin_divLoginErrorMessage');
    ...
    var addMessage = function addMessage() {
      var ref = document.querySelector('#dnn_ctr88149_Launch_registerLogin_divLoginErrorMessage');
      document.body.classList.add('FL063-wrongPsw');
      events.send('FL063', 'Forgot password', 'User entered incorrect details');
      var html = null;
      if (settings.VARIATION === '1') {
    ...
    var storeEmail = function storeEmail() {
      var emailInput = document.querySelector('.existingCustomer .loginContainer .field.SignLogIn2 input#dnn_ctr88149_Launch_registerLogin_txtExistingCustomerEmailAddress');
      if (emailInput) {
    ...
    var activate = function activate() {
      ...
      var loginCta = document.querySelector('.loginContainer #dnn_ctr88149_Launch_registerLogin_btnRegisteredCustomer');
      setup();
      if (loginCta) {
      ...
      if (settings.VARIATION === '1') {
        observeMessage(function () {
          ...
          pollerLite(['#FL034-guest'], function () {
            var existingGuestCheckoutCta = document.querySelector('.newCustomer .innerBorder .loginContainer .NewCustWrap a#dnn_ctr88149_Launch_btnGuestCustomer');
    ...
    pollerLite(['body', '.existingCustomer .loginContainer .field.SignLogIn2 input#dnn_ctr88149_Launch_registerLogin_txtExistingCustomerEmailAddress', '.newCustomer .innerBorder .loginContainer input#txtGuestCustomerEmailAddress', '#dnn_ctr88149_Launch_registerLogin_divLoginErrorMessage'], activate);
    })();
};
