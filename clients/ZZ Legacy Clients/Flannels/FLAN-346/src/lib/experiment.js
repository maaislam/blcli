...
const initiateSlider = () => {
  ...
  setTimeout(function() {
  	...
  	outerImageHeight = outerImageHeight - 80;
...
const buildOuterHTML = (method) => {
	...
	if(method == "create") {
		...
		ref.insertAdjacentHTML('beforebegin', `
			...
			<div class="FLAN-346-content-holder active">
						...
						<div class="add-to-bag-holder">
							...
							<div class="bag-details-holder">
								<div class="product-image">
									<img id="FLAN-346-product-image" src="${prodDetails['prodImageURL']}" alt="product image" class="atb-image" />
								</div>
								<div class="product-content">
									...
									<div class="product-content-inner">
										...
										<p id="FLAN-346-product-brand" class="prod-brand"> ${prodDetails['brand']} </p>
										<div class="product-name-holder">
											<p id="FLAN-346-product-name" class="product-name"> ${prodDetails['name']}</p> - <p class="product-size" id="FLAN-346-product-size">${prodDetails['size']}</p> 
										</div>
										<p class="price ${ prodDetails['price'] == prodDetails['wasprice'] ? 'equal-prices' : ''}"> 
											<span id="FLAN-346-product-price" class="now-price">${prodDetails['price']}</span>
											<span id="FLAN-346-product-wasprice" class="was-price">${prodDetails['wasprice']}</span>
										</p>
									</div>
								</div>
							</div>
							<div class="bag-buttons-holder">
								...
								<a id="continue-to-checkout" href="/checkoutselect" class="cta primary-cta"> Checkout Now </a>
							</div>
						</div>
		...
		contentHolder = document.querySelector('.FLAN-346-content-holder');
		...
		if(styleCollect == true) {
			...
			let scHTML = `
				<div class="FLAN-346-SC-banner">
			      <a href="#" id="banner-what-is-SC" class="FLAN-346-SC-banner-link">
			        <div class="SC-banner-logo">
			          <img src="https://cdn-eu.dynamicyield.com/api/9876944/images/296edda0bad8f__sc-header.jpg" alt="style & collect from Flannels logo" />
			        </div>

			        <div class="SC-banner-text">
			          <p id="FLAN-346-SC-amount-text">${ bannerMethod == "less-than-250" ? "<span>Spend £250</span> to be eligible" : "Select <span>Click &amp; Collect</span> at checkout" }</p>
			        </div>
			...
			let recsCarouselHolder = document.querySelector('.FLAN-346 .may-also-like-header');
			...
			observer.connect(wrap, (e) => {
				...
				let eleToChange = document.querySelector('.FLAN-346 .SC-banner-text p');
				if(amount < 250) {
		...
		prodDetails = getProductDetails();
		document.getElementById('FLAN-346-product-image').setAttribute('src', prodDetails['prodImageURL']);
		document.getElementById('FLAN-346-product-name').innerHTML = prodDetails['name'];
		document.getElementById('FLAN-346-product-price').innerHTML = prodDetails['price'];
		document.getElementById('FLAN-346-product-size').innerHTML = prodDetails['size'];
		document.getElementById('FLAN-346-product-brand').innerHTML = prodDetails['brand'];
		document.getElementById('FLAN-346-product-wasprice').innerHTML = prodDetails['wasprice'];

		let checkAmt = checkBasketAmount();
		let bannerMethod = "";

		if(checkAmt < 250) {
			document.getElementById('FLAN-346-SC-amount-text').innerHTML = "<span>Spend £250</span> to be eligible";
		} else {
			document.getElementById('FLAN-346-SC-amount-text').innerHTML = "Select <span>Click &amp; Collect</span> at checkout";
		}
	}
...
const createSCPopup = (method) => {
  ...
  let popupHTML = `
    ...
    <div class="FLAN-346-SC-popup">

      <div class="FLAN-346-SC-overlay"></div>

      <div class="FLAN-346-SC-popup-inner">

      	<div class="FLAN-346-SC-popup-inner-scrollable">

	        <a href="#" id="FLAN-346-SC-close-element" class="FLAN-346-SC-close-element"><svg height="20" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="20" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path stroke-width="1" stroke="red" d="M443.6,387.1L312.4,255.4l131.5-130c5.4-5.4,5.4-14.2,0-19.6l-37.4-37.6c-2.6-2.6-6.1-4-9.8-4c-3.7,0-7.2,1.5-9.8,4  L256,197.8L124.9,68.3c-2.6-2.6-6.1-4-9.8-4c-3.7,0-7.2,1.5-9.8,4L68,105.9c-5.4,5.4-5.4,14.2,0,19.6l131.5,130L68.4,387.1  c-2.6,2.6-4.1,6.1-4.1,9.8c0,3.7,1.4,7.2,4.1,9.8l37.4,37.6c2.7,2.7,6.2,4.1,9.8,4.1c3.5,0,7.1-1.3,9.8-4.1L256,313.1l130.7,131.1  c2.7,2.7,6.2,4.1,9.8,4.1c3.5,0,7.1-1.3,9.8-4.1l37.4-37.6c2.6-2.6,4.1-6.1,4.1-9.8C447.7,393.2,446.2,389.7,443.6,387.1z"/></svg></a>

	        <img src="https://cdn-eu.dynamicyield.com/api/9876944/images/296edda0bad8f__sc-header.jpg" alt="Style & Collect from Flannels" />
	        ...
	        <div class="FLAN-346-steps">

	          <div class="FLAN-346-step step-one">
	            <div class="FLAN-346-step-icon">
	          ...
	          <div class="FLAN-346-step step-two">
	            <div class="FLAN-346-step-icon">
	          ...
	          <div class="FLAN-346-step step-three">
	            <div class="FLAN-346-step-icon">
	          ...
	          <div class="FLAN-346-step step-four">
	            <div class="FLAN-346-step-icon">
	        ...
	        <a class="styled-button" href="#" id="FLAN-346-SC-continueshopping"><span>CONTINUE SHOPPING</span></a>
  ...
  bannerClickElement.addEventListener('click', (e) => {
    e.preventDefault();
    if(!document.querySelector('.FLAN-346-SC-popup').classList.contains('active')) {
      document.querySelector('.FLAN-346-SC-popup').classList.add('active');
      document.documentElement.classList.add('FLAN-346-noscroll');
  ...
  let closeClickElement = document.getElementById('FLAN-346-SC-close-element');
  closeClickElement.addEventListener('click', (e) => {
    e.preventDefault();
    document.querySelector('.FLAN-346-SC-popup').classList.remove('active');
    document.documentElement.classList.remove('FLAN-346-noscroll');
  });

  let ctbClickElement = document.getElementById('FLAN-346-SC-continueshopping');
  ...
  let outwithInnerClickElement = document.querySelector('.FLAN-346-SC-overlay');
...
const startTakeover = () => {
	...
	if(document.querySelector('.FLAN-346-content-holder')) {
...
const activate = () => {
    ...
    () => {
    	...
    	document.body.classList.add('FLAN-346-test-active');
