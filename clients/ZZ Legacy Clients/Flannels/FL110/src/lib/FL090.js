            ...
            fetchAffinity().then((res) => {
              ...
              if (brandArr) {
                ...
                configArr.map((confItem, index) => {
                  ...
                  console.log('conf brand ', confBrand);
                  brandArr.forEach((el) => {
                    // console.log('el ', el);
                    if (el && typeof el === 'string' && confBrand.toLowerCase() == el.toLowerCase()) {
                ...
                var hasImages = newConfigArr.filter(function (obj) {
