       ...
       'Top Brands': [
        ...
        'By Concern': [
                  '<div class="ucfacial con">',
                    '<ul class="ucsmalllinks">',
                            '<li><a href="http://www.currentbody.com/face/skin-cleansers.html">Pores/Blackheads</a></li>',
                            '<li><a href="http://www.currentbody.com/face/skin-cleansers.html">Pigmentation</a></li>',
                            '<li><a href="http://www.currentbody.com/face/skin-cleansers.html">Lines/Wrinkles</a></li>',
                            '<li><a href="http://www.currentbody.com/face/skin-cleansers.html">Oily Skin</a></li>',
                            '<li><a href="http://www.currentbody.com/face/skin-cleansers.html">Dull Skin</a></li>',
                     '</ul>',
                  '</div>'
                  ].join(''),
    ...
    'Hair Removal': {
        ...
        'By Concern': [
                  '<div class="uchair con">',
                    '<ul class="ucsmalllinks">',
                            '<li><a href="http://www.currentbody.com/hair-and-nails/unwanted-hair-removed.html">Unwanted Facial Hair</a></li>',
                            '<li><a href="http://www.currentbody.com/hair-and-nails/unwanted-hair-removed.html">Unwanted Bikini Line Hair</a></li>',
                            '<li><a href="http://www.currentbody.com/hair-and-nails/unwanted-hair-removed.html">Unwanted Body Hair</a></li>',
                            '<li><a href="http://www.currentbody.com/hair-and-nails/unwanted-hair-removed.html">Light Body Hair</a></li>',
                            '<li><a href="http://www.currentbody.com/hair-and-nails/unwanted-hair-removed.html">Darker Skin</a></li>',   
                     '</ul>',
                    '</div>'
                  ].join(''),
    ...
    'Anti-Ageing': {
      'Top Brands': [
        ...
        'By Concern': [
                  '<div class="ucage con">',
                        '<ul class="ucsmalllinks">',
                            '<li><a href="http://www.currentbody.com/face/anti-aging.html">Eye Area/Crow\'s Feet</a></li>',
                            '<li><a href="http://www.currentbody.com/face/anti-aging.html">Fine Lines/Wrinkles</a></li>',
           '<li><a href="http://www.currentbody.com/face/anti-aging.html">Sagging Neck</a></li>',
          '<li><a href="http://www.currentbody.com/face/anti-aging.html">Untoned Skin</a></li>',
    ...
    'Acne': {
      'Top Brands': [
        ...
        'By Concern': [
                  '<div class="ucage con">',
                        '<ul class="ucsmalllinks">',
          '<li><a href="http://www.currentbody.com/face/acne-spot-removal.html">Mild Acne</a></li>', 
          '<li><a href="http://www.currentbody.com/face/acne-spot-removal.html">Moderate Acne</a></li>',
          '<li><a href="http://www.currentbody.com/face/acne-spot-removal.html">Blemishes</a></li>',
          '<li><a href="http://www.currentbody.com/face/acne-spot-removal.html">Body Acne</a></li>', 
                     '</ul>',
                    '</div>'
                  ].join(''),
...
//changed to sale
    ...
    'All Beauty Technology': {
        ...
        'Body': [
                  '<div class="ucbrand con">',
                        '<ul class="ucsmalllinks">',
                            ...
                            '<li><a href="http://www.currentbody.com/body/female-health.html">Female Health</a></li>',
        ...
        'Outlet': [
                    '<div class="ucbrand bestseller">',
                        '<ul class="ucsmalllinks">',
                            '<li><a href="http://www.currentbody.com/outlet">Face</a></li>',
                            '<li><a href="http://www.currentbody.com/outlet">Body</a></li>',
                            '<li><a href="http://www.currentbody.com/outlet">Hair & Nails</a></li>',
                            '<li><a href="http://www.currentbody.com/outlet">Teeth</a></li>',
                            '<li><a href="http://www.currentbody.com/outlet">Health & Wellbeing</a></li>',
                        '</ul>',
                    '</div>'
                  ].join(''),
  ...
  'Brands': {
        'A': [
                    '<div class="ucbrand cat">',
                        '<ul class="ucsmalllinks">',
                            '<li><a href="http://www.currentbody.com/alpha_stim">Alpha Stim</a></li>',
                        '</ul>',
                    '</div>'
                  ].join(''),
        ...
        'C': [
                  '<div class="ucbrand con">',
                    '<ul class="ucsmalllinks">',
                            ...
                            '<li><a href="http://www.currentbody.com/clarisonic">Clarisonic</a></li>',
                            '<li><a href="https://www.currentbody.com/crystal_clear">Crystal Clear</a></li>',
                     '</ul>',
                    '</div>'
                  ].join(''),
        ...
        'E': [
                     '<div class="ucbrand brands">',
                        '<ul class="ucsmalllinks">',
							...
							'<li><a href="http://www.currentbody.com/eylure">Eylure</a></li>', 
                        '</ul>',
                    '</div>'
                  ].join(''),
        'F': [
        ...
        'G': [
                     '<div class="ucbrand brands">',
                        '<ul class="ucsmalllinks">',
                            ...
                            '<li><a href="http://www.currentbody.com/glopro">GloPRO</a></li>',
                        '</ul>',
                    '</div>'
                  ].join(''),
        'H': [
        ...
        'I': [
                     '<div class="ucbrand brands">',
                        '<ul class="ucsmalllinks">',
                            ...
                            '<li><a href="http://www.currentbody.com/iluminage">iluminage</a></li>',
                            '<li><a href="http://www.currentbody.com/instyler">InStyler</a></li>',
                            '<li><a href="http://www.currentbody.com/intimina">INTIMINA</a></li>',
                            '<li><a href="http://www.currentbody.com/iwhite">iWhite</a></li>',
                        '</ul>',
                    '</div>'
                  ].join(''),
        'L': [
                     '<div class="ucbrand brands">',
                        '<ul class="ucsmalllinks">',
                            ...
                            '<li><a href="http://www.currentbody.com/love_my_skin">Love My Skin</a></li>',
        ...
        'P': [
                     '<div class="ucbrand brands">',
                        '<ul class="ucsmalllinks">',
                            ...
                            '<li><a href="http://www.currentbody.com/philips">Philips</a></li>',
                            '<li><a href="http://www.currentbody.com/pmd">PMD</a></li>',
                            '<li><a href="http://www.currentbody.com/prai_beauty">PRAI Beauty</a></li>',
        ...
        'S': [
                     '<div class="ucbrand brands">',
                        '<ul class="ucsmalllinks">',
                             "<li><a href='http://www.currentbody.com/sensica'>Sensica</a></li>",
                            "<li><a href='http://www.currentbody.com/silk_n'>Silk'n</a></li>",
                            '<li><a href="http://www.currentbody.com/slendertone">Slendertone</a></li>',
                            '<li><a href="http://www.currentbody.com/smoothskin">SmoothSkin</a></li>',
          									'<li><a href="http://www.currentbody.com/sqoom">Sqoom</a></li>',
                        '</ul>',
                    '</div>'
                  ].join(''),
        'T': [
                     '<div class="ucbrand brands">',
                        '<ul class="ucsmalllinks">',
                            ...
                            '<li><a href="http://www.currentbody.com/theradome">Theradome</a></li>',
                             ...
                             '<li><a href="http://www.currentbody.com/tweezerman">Tweezerman</a></li>',
                        '</ul>',
                    '</div>'
                  ].join(''),
      ...
      '<div class="ucbrand brands">',
                        '<ul class="ucsmalllinks">',
                            '<li><a href="http://www.currentbody.com/valkee">Valkee</a></li>',
                            "<li><a href='http://www.currentbody.com/joylux'>vSculpt</a></li>",
                        '</ul>',
      ].join(''),  
    	'W': [
                     '<div class="ucbrand brands">',
...
$(['<div class="uc-toprow facial">',
    ...
    '<a href="http://www.currentbody.com/face/skin-cleansers.html">View All  ></a></h2>',
...
$(['<div class="uc-toprow hair">',
    ...
    '<a href="http://www.currentbody.com/hair-and-nails/hair-removal.html">View All  ></a></h2>',
    '<h2 class="uc-bestselling-title">Best Sellers</h2>',
  '</div>'].join('')).prependTo('.ucnavContent:eq(1)');

$(['<div class="uc-toprow age">',
    '<h2 class="uc-box-title">Anti-Ageing',
    '<a href="http://www.currentbody.com/face/anti-aging.html">View All  ></a></h2>',
    '<h2 class="uc-bestselling-title">Best Sellers</h2>',
  '</div>'].join('')).prependTo('.ucnavContent:eq(2)');

$(['<div class="uc-toprow acne">',
    '<h2 class="uc-box-title">Acne',
    '<a href="http://www.currentbody.com/face/acne-spot-removal.html">View All  ></a></h2>',
    '<h2 class="uc-bestselling-title">Best Sellers</h2>',
