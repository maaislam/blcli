    ...
    function init(){
		...
		var cacheDom = (function() {
			...
			return {
				...
				UKDeliveryCircle: UKDeliveryCircle
			};
		})();
				...
				if(cacheDom.currentURL == 'triaHair'){
					cacheDom.ExpertsTabContent = [
						...
						'<div class="CB080_life_icon-wrap clearfix">',
							'<div class="CB080_lifestyle">',
								...
								'<div><img src="http://www.sitegainer.com/fu/up/q8qox4iphhetm17.jpg" /> Social </div>',
							'</div>',
							'<div class="CB080_skin-types">',
								'<h4>Skin types <br/> most effective</h4>',
								'<div><img src="http://www.sitegainer.com/fu/up/xpkj3s9g9psl31v.jpg" /> Light skin</div>',
							'</div>',
						'</div>',
						'<div class="CB080_product-finder clearfix">',
							'<div class="CB080_img-block" style="background-image: url(https://www.sitegainer.com/fu/up/8wy7p8817wujq5h.jpg)"></div>',
						...
						'<div class="CB080_product-use clearfix">',
							'<h2>How to use your Tria 4x</h2>',
							'<div class="CB080_use-step clearfix">',
								'<span>1.</span>',
								'<p>Prep your skin Clean, shave and towel dry your skin to optimise your treatment.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>2.</span>',
								'<p>Select a treatment level Choose from 5 energy levels to customise your treatment. We recommend starting on a low setting and working your way up the levels to maximise comfort.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>3.</span>',
								'<p>Begin treating the skin Select the area you would like to treat and position the device against the skin. After each pulse, lift and place the tip in an overlapping pattern.</p>',
							'</div>',
							'<p class="CB080_smallprint">For best results, we recommend using the device as directed for at least 12 treatments to achieve a substantial visible reduction in hair growth. Please note that some users may require additional treatments depending on skin tone and hair type.</p>',
						'</div>'
					].join('');
						...
						'<section class="CB080_delivery-wrap">',
							'<div class="clearfix">',
								'<div class="CB080_delivery-content">',
									'<h2>Delivery</h2>',
									'<p>We offer a range of delivery options to suit your schedule.</p>',
									'<ul class="CB080_dot-variant">',
										'<li><strong>Standard Delivery</strong> - £2.50</li>',
										'<li><strong>Express Delivery</strong> - £4.50</li>',
									'</ul>',
									'<p>For international orders, please select your country from the drop down above to see updated delivery costs.</p>',
								'</div>',
								'<div class="CB080_delivery-circle CB080_uk-delivery" style="background-image: url(\'http://www.sitegainer.com/fu/up/lzsja9th0tx8e01.jpg\');">',
						...
						'<section class="CB080_delivery-wrap">',
							'<div class="clearfix">',
								'<div class="CB080_delivery-content">',
									...
									'<p>We\'re so confident that you\'ll get results you\'ll love with your Tria from the first use that we offer a 90-day money back guarantee</p>',
					...
					cacheDom.ExpertsTabContent = [
						...
						'<div class="CB080_life_icon-wrap clearfix">',
							...
							'<div class="CB080_skin-types">',
								'<h4>Skin types <br/> most effective</h4>',
								'<div><img src="http://www.sitegainer.com/fu/up/xpkj3s9g9psl31v.jpg" /> Suitable on all skin</div>',
							'</div>',
						'</div>',
						'<div class="CB080_product-use clearfix">',
							'<h2>How to use your NuFACE Trinity</h2>',
							'<div class="CB080_use-step clearfix">',
								'<span>1.</span>',
								'<p>Prep your skin Cleanse the skin of any impurities and make-up residue.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>2.</span>',
								'<p>Turn on the device Toggle the appropriate button until all the blue lights have illuminated. The intensity can also be adjusted for optimal comfort at any time.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>3.</span>',
								'<p>Apply the gel Smooth the NuFACE Gel Primer over the section that you would like to treat, beginning with the cheek.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>4.</span>',
								'<p>Lift Up Position the device at the base of the treatment area and glide upwards across the section until you hear the beep.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>5.</span>',
								'<p>Repeat Move on to the next section, applying the gel before repeating the gliding lift motion with the device.</p>',
							'</div>',
							'<p class="CB080_smallprint">For best results, we recommend using the device as directed for 5 minutes per day 5 times a week for at least a month. This ensures that you have given the device a proper chance to start working on your skin.</p>',
						'</div>'
					].join('');
					...
					cacheDom.deliveryContentVar = [
						...
						'<section class="CB080_delivery-wrap">',
							'<div class="clearfix">',
								'<div class="CB080_delivery-content">',
									'<h2>90 Day Money Back Guarantee</h2>',
									'<p>We\'re so confident that you\'ll get results you\'ll love with your NuFace from the first use that we offer a 90-day money back guarantee</p>',
									'<ul class="CB080_tick-variant">',
										'<li>We ask that you have used the device for 60 seconds a day for 30 days to see consistent results.</li>',
										'<li>By using it for a month. it ensures that you have given the device a proper chance to start working on your skin.</li>',
										'<li>If you are still not satisfied, you can return the device for a 90-day money back guarantee.</li>',
					...
					cacheDom.ExpertsTabContent = [
						...
						'<div class="CB080_life_icon-wrap clearfix">',
							'<div class="CB080_lifestyle">',
								'<h4>Would suit <br/> these lifestyles</h4>',
								'<div><img src="http://www.sitegainer.com/fu/up/l8hy0axofcfm3cv.jpg" /> Social </div>',
							'</div>',
							'<div class="CB080_skin-types">',
								'<h4>Skin types <br/> most effective</h4>',
								'<div><img src="http://www.sitegainer.com/fu/up/xpkj3s9g9psl31v.jpg" /> Sensitive skin</div>',
							'</div>',
						'</div>',
						'<div class="CB080_product-finder clearfix">',
							'<div class="CB080_img-block" style="background-image: url(https://www.sitegainer.com/fu/up/8wy7p8817wujq5h.jpg)"></div>',
						...
						'</div>',
						'<div class="CB080_product-use clearfix">',
							'<h2>How to use your SmoothSkin Gold</h2>',
							'<div class="CB080_use-step clearfix">',
								'<span>1.</span>',
								'<p>Prepare the skin Shave away any visible hair from the treatment area, cleanse and pat dry.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>2.</span>',
								'<p>Power the device Connect to the power supply, illuminating the standby button in blue. Press the standby button to illuminate in white, signalling its ready for use.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>3.</span>',
								'<p>Engage skin tone sensors Press the handset firmly against the treatment area. Ensure a valid skin tone is displayed on the power bars before continuing.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>4.</span>',
								'<p>Begin treatment Press the activation button to begin your treatment. We recommend using the gliding technique for larger areas, and the stamp method for smaller areas.</p>',
							'</div>',
							'<p class="CB080_smallprint">For best results, we recommend using the device every weeks for 12 weeks to ensure all hair follicles are treated. To maintain results, an additional treatment once a month may be required.</p>',
						'</div>'
					].join('');
					...
					cacheDom.deliveryContentVar = [
						...
						'<section class="CB080_delivery-wrap">',
							'<div class="clearfix">',
								'<div class="CB080_delivery-content">',
									'<h2>90 Day Money Back Guarantee</h2>',
									'<p>We\'re so confident that you\'ll get results you\'ll love with your SmoothSkin from the first use that we offer a 90-day money back guarantee</p>',
									'<ul class="CB080_tick-variant">',
										'<li>We ask that you have used the device for 60 seconds a day for 30 days to see consistent results.</li>',
										'<li>By using it for a month. it ensures that you have given the device a proper chance to start working on your skin.</li>',
										'<li>If you are still not satisfied, you can return the device for a 90-day money back guarantee.</li>',
					...
					cacheDom.ExpertsTabContent = [
						...
						'</div>',
						'<div class="CB080_product-use clearfix">',
							'<h2>How to use your NuFACE Mini</h2>',
							'<div class="CB080_use-step clearfix">',
								'<span>1.</span>',
								'<p>Prep your skin Cleanse the skin of any impurities and make-up residue.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>2.</span>',
								'<p>Turn on the device Toggle the appropriate button until all the blue lights have set to the far right. The intensity can also be adjusted for optimal comfort at any time.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>3.</span>',
								'<p>Apply the gel Smooth the NuFACE Gel Primer over the section that you would like to treat, beginning with the cheek.</p>',
					...
					cacheDom.ExpertsTabContent = [
						...
						'<div class="CB080_life_icon-wrap clearfix">',
							'<div class="CB080_lifestyle">',
								'<h4>Would suit <br/> these lifestyles</h4>',
								'<div><img src="http://www.sitegainer.com/fu/up/l8hy0axofcfm3cv.jpg" /> On the Go </div>',
								'<div><img src="http://www.sitegainer.com/fu/up/l8hy0axofcfm3cv.jpg" /> Healthy</div>',
							'</div>',
							'<div class="CB080_skin-types">',
								'<h4>Skin types <br/> most effective</h4>',
								'<div><img src="http://www.sitegainer.com/fu/up/xpkj3s9g9psl31v.jpg" /> Suitable on all skin</div>',
						...
						'</div>',
						'<div class="CB080_product-use clearfix">',
							'<h2>How to use your Clarisonic Mia 2</h2>',
							'<div class="CB080_use-step clearfix">',
								'<span>1.</span>',
								'<p>Cleanse the eye area Remove eye make-up by hand. As this is a delicate area, we strongly recommend treating in this zone with your Clarisonic device.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>2.</span>',
								'<p>Apply cleanser Moisten the skin and apply cleanser to your dampened brush head.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>3.</span>',
								'<p>Activate the device Press the on/off button to turn on your cleansing brush and select the desired speed with the arrows.</p>',
							'</div>',
							'<div class="CB080_use-step clearfix">',
								'<span>4.</span>',
								'<p>Begin treatment Apply the brush to your forehead in circular motions. Follow the T-Timer prompts to move your device onto the next quadrant of your face.</p>',
							'</div>',
							'<p class="CB080_smallprint">For best results, we recommend using this device twice daily. With continued use, the deep cleanse will make your skin appear brighter with a natural radiance.</p>',
						'</div>'
					].join('');
					...
					cacheDom.deliveryContentVar = [
						...
						'<section class="CB080_delivery-wrap">',
							'<div class="clearfix">',
								'<div class="CB080_delivery-content">',
									'<h2>90 Day Money Back Guarantee</h2>',
									'<p>We\'re so confident that you\'ll get results you\'ll love with your Clarisonic from the first use that we offer a 90-day money back guarantee</p>',
									'<ul class="CB080_tick-variant">',
										'<li>We ask that you have used the device for 60 seconds a day for 30 days to see consistent results.</li>',
										'<li>By using it for a month. it ensures that you have given the device a proper chance to start working on your skin.</li>',
										'<li>If you are still not satisfied, you can return the device for a 90-day money back guarantee.</li>',
		...
		var UKDeliveryMessage = {
			ukCheck: function(){
				cacheDom.UKDeliveryCircle = cacheDom.JQ('.CB080_uk-delivery');

				if(cacheDom.JQ('#ajax-update-container .uk-link').length > 0){
				    cacheDom.UKDeliveryCircle.show();
				}
				else{
					cacheDom.UKDeliveryCircle.hide();
				}
			}
		}
		...
		var countryLocation = {
		    countryChange: function(){
		        var countrySelect = cacheDom.JQ('#country');
		        
		        countrySelect.on('change', function(){
                	var elVal = cacheDom.JQ(this).val();
		...
		UKDeliveryMessage.ukCheck();
		countryLocation.countryChange();
