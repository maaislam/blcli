...
var UCNAV = (function($) {
  ...
  var // bestSellersFaciallink1 = $('.menu_a_1').attr('data-link'),
      bestSellersFaciallink1 = '//www.currentbody.com/clarisonic-mia-2-facial-cleanser.html',
      // bestSellersFacialimage1 = $('.menu_a_1').attr('data-img'),
      bestSellersFacialimage1 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/716x/9df78eab33525d08d6e5fb8d27136e95/c/l/cl-mia2-whi.jpg',
      // bestSellersFacialname1 = $('.menu_a_1').attr('data-name'),
      bestSellersFacialname1 = 'Clarisonic Mia 2',
      bestSellersFacialprice1,
      
      // bestSellersFaciallink2 = $('.menu_a_2').attr('data-link'),
      bestSellersFaciallink2 = '//www.currentbody.com/pmd-personal-microdermabrasion-facial-exfoliating-device.html',
      // bestSellersFacialimage2 = $('.menu_a_2').attr('data-img'),
      bestSellersFacialimage2 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/716x/9df78eab33525d08d6e5fb8d27136e95/_/p/_pm-int-pnk-config.jpg',
      // bestSellersFacialname2 = $('.menu_a_2').attr('data-name'),
      bestSellersFacialname2 = 'PMD Classic Microdermabrasion',
      bestSellersFacialprice2,
    
      // bestSellersFaciallink3 = $('.menu_a_3').attr('data-link'),
      bestSellersFaciallink3 = '//www.currentbody.com/clarisonic-smart-profile-uplift-anti-ageing-massage-and-cleansing.html',
      // bestSellersFacialimage3 = $('.menu_a_3').attr('data-img'),
      bestSellersFacialimage3 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/716x/9df78eab33525d08d6e5fb8d27136e95/c/l/cl-smart-uplift.jpg',
      // bestSellersFacialname3 = $('.menu_a_3').attr('data-name'),
      bestSellersFacialname3 = 'Clarisonic Smart Profile Uplift',
      bestSellersFacialprice3,
    
    /*HAIR REMOVAL*/
      // bestSellersHairRemovalink1 = $('.menu_b_1').attr('data-link'),
      bestSellersHairRemovalink1 = '//www.currentbody.com/tria-hair-removal-laser-4x.html',
      // bestSellersHairRemovalimage1 = $('.menu_b_1').attr('data-img'),
      bestSellersHairRemovalimage1 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/716x/9df78eab33525d08d6e5fb8d27136e95/t/r/tr-hlr4x-config-2.jpg',
      // bestSellersHairRemovalname1 = $('.menu_b_1').attr('data-name'),
      bestSellersHairRemovalname1 = 'Tria Hair Removal Laser 4x',
      bestSellersHairRemovalprice1,
      
      // bestSellersHairRemovalink2 = $('.menu_b_2').attr('data-link'),
      bestSellersHairRemovalink2 = '//www.currentbody.com/iluminagetouch.html',
      // bestSellersHairRemovalimage2 = $('.menu_b_2').attr('data-img'),
      bestSellersHairRemovalimage2 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/716x/9df78eab33525d08d6e5fb8d27136e95/i/l/il-fg70701uk-config_1.jpg',
      // bestSellersHairRemovalname2 = $('.menu_b_2').attr('data-name'),
      bestSellersHairRemovalname2 = 'iluminage TOUCH Permanent Hair Reduction System',
      bestSellersHairRemovalprice2,
    
      // bestSellersHairRemovalink3 = $('.menu_b_3').attr('data-link'),
      bestSellersHairRemovalink3 = '//www.currentbody.com/philips-lumea-prestige-bri950-00-ipl-hair-removal-device.html',
      // bestSellersHairRemovalimage3 = $('.menu_b_3').attr('data-img'),
      bestSellersHairRemovalimage3 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/716x/9df78eab33525d08d6e5fb8d27136e95/p/h/philips-10.png',
      // bestSellersHairRemovalname3 = $('.menu_b_3').attr('data-name'),
      bestSellersHairRemovalname3 = 'Philips Lumea Prestige BRI950/00',
      bestSellersHairRemovalprice3,
      
    /*AGEING*/
      
      // bestSellersAgeinglink1 = $('.menu_c_1').attr('data-link'),
      bestSellersAgeinglink1 = '//www.currentbody.com/nuface-trinity.html',
      // bestSellersAgeingimage1 = $('.menu_c_1').attr('data-img'),
      bestSellersAgeingimage1 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/716x/9df78eab33525d08d6e5fb8d27136e95/n/f/nf-tr-40150-whi_1.jpg',
      // bestSellersAgeingname1 = $('.menu_c_1').attr('data-name'),
      bestSellersAgeingname1 = 'NuFACE Trinity Facial Toner',
      bestSellersAgeingprice1,
      
      // bestSellersAgeinglink2 = $('.menu_c_2').attr('data-link'),
      bestSellersAgeinglink2 = '//www.currentbody.com/tripollar-stop-reduce-wrinkles-tighten-and-tone-the-skin-on-your-face-neck-hands.html',
      // bestSellersAgeingimage2 = $('.menu_c_2').attr('data-img'),
      bestSellersAgeingimage2 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/716x/9df78eab33525d08d6e5fb8d27136e95/t/r/tripollar-stop-white.jpg',
      // bestSellersAgeingname2 = $('.menu_c_2').attr('data-name'),
      bestSellersAgeingname2 = 'TriPollar STOP',
      bestSellersAgeingprice2,
    
      // bestSellersAgeinglink3 = $('.menu_c_3').attr('data-link'),
      bestSellersAgeinglink3 = '//www.currentbody.com/glopro-microneedling-regeneration-tool.html',
      // bestSellersAgeingimage3 = $('.menu_c_3').attr('data-img'),
      bestSellersAgeingimage3 = '//www.currentbody.com/media/catalog/product/g/l/glopro-eye-2.jpg',
      // bestSellersAgeingname3 = $('.menu_c_3').attr('data-name'),
      bestSellersAgeingname3 = 'GloPRO Microneedling Tool',
      bestSellersAgeingprice3,
      
      /*ACNE*/
      
      // bestSellersAcnelink1 = $('.menu_d_1').attr('data-link'),
      bestSellersAcnelink1 = '//www.currentbody.com/baby-quasar-clear-rayz-for-acne.html',
      // bestSellersAcneimage1 = $('.menu_d_1').attr('data-img'),
      bestSellersAcneimage1 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/60x/9df78eab33525d08d6e5fb8d27136e95/q/s/qs-clear-rayz-021-her-white.jpg',
      // bestSellersAcnename1 = $('.menu_d_1').attr('data-name'),
      bestSellersAcnename1 = 'Baby Quasar Clear Rayz For Acne',
      bestSellersAcneprice1,
      
      // bestSellersAcnelink2 = $('.menu_d_2').attr('data-link'),
      bestSellersAcnelink2 = '//www.currentbody.com/foreo-espada-blue-light-acne-treatment-device.html',
      // bestSellersAcneimage2 = $('.menu_d_2').attr('data-img'),
      bestSellersAcneimage2 = '//www.currentbody.com/media/catalog/product/cache/1/image/358x/9df78eab33525d08d6e5fb8d27136e95/1/2/1200x1200-front-side-image-pink-front.jpg',
      // bestSellersAcnename2 = $('.menu_d_2').attr('data-name'),
      bestSellersAcnename2 = 'FOREO ESPADA',
      bestSellersAcneprice2,
    
      // bestSellersAcnelink3 = $('.menu_d_3').attr('data-link'),
      bestSellersAcnelink3 = '//www.currentbody.com/pmd-pink-beige-pro-personal-microdermabrasion-device.html',
      // bestSellersAcneimage3 = $('.menu_d_3').attr('data-img'),
      bestSellersAcneimage3 = '//www.currentbody.com/media/catalog/product/cache/1/thumbnail/60x/9df78eab33525d08d6e5fb8d27136e95/p/m/pm-int-1001-pro_1.jpg',
      // bestSellersAcnename3 = $('.menu_d_3').attr('data-name'),
      bestSellersAcnename3 = 'PMD Pro Microdermabrasion',
