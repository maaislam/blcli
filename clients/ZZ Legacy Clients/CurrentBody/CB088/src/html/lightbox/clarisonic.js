const clarisonicLightboxHtml = `
    <div class="cb88-sidetab">
        <div class="cb88-sidetab__title">
            <span class="cb88-sidetab__title1">Facial Cleanser</span> 
        ...
        <div>
            ...
            <div class="overflow_fix">
                <div class="col-sm-6 cb88-pa0 cb88-lightbox__imgcontainer">
                    <img src="//www.sitegainer.com/fu/up/p63pz2vx0coaq05.jpg" />
                </div>
                <div class="col-sm-6 text-center cb88-pa20 cb88-relative cb88-lightbox__desc">
                    <h2>Try our product finder</h2>
                    <p class="cb88-subtitle">Find the perfect facial cleanser for your skin</p>
                    <p class="text-center">
...
`;
export default clarisonicLightboxHtml;
