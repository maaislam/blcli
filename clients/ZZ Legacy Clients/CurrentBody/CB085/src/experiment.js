...
var _CB085 = (function() {
	...
	var _activate = function() {
		...
		function desktopHeader() {
			...
			---------------------------------------*/
			var $desktopWrap = $('<div class="CB85-topBar_desktop"/><div class="container-fluid CB85-searchRow"/>'),
			...
			$desktopWrap.filter('.CB85-searchRow').html(
				`<div class="CB85-desktoplogo">
				 <a href="https://www.currentbody.com/"><img src="${$topImages.cblogo}"/></a></div>
		  ...
		  //create top row
			...
			--------------------------------------*/
			const shoppingBasket = $('#cart-block-content');
			shoppingBasket.insertAfter('#cart-block');
			...
			function desktopUSPs() {
				...
				$('.CB85-usp').hover(function() {
					utils.events.send('CB085 V1', 'Usp hover', 'CB085 V1 USP Hover', {sendOnce: true});
				});
				$('.CB85-usp').click(function(){
					utils.events.send('CB085 V1', 'Usp click', 'CB085 V1 USP Click', {sendOnce: true});
				});
	...
	var _triggers = function(options) {
		utils.fullStory('CB085', 'Variation 1');
