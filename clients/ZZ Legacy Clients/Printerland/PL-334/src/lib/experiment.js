...
export default (data) => {
  ...
  function getTonerPrice() {
    const element = document.querySelector(".product__key_features .costper-page > span > span > span");
    // console.log(element);
  ...
  (function renderElements() {
    const entry = document.querySelector(".product__main_container .container.bg-gray .modal-section__body");
