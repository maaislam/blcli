...
export const generateLightbox = (variation) => {
  const { ID, VARIATION } = shared;
  ...
  const lightboxContainer = `<div class="${shared.ID}-lightbox__wrapper ${shared.ID}-lightbox__wrapper-v${shared.VARIATION}" data-anchor="9">
