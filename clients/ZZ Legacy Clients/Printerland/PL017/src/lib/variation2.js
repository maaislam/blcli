...
export default () => {
  const mainContainer = document.querySelector('.filter-container.search');
  mainContainer.classList.add('mainContainer_V2');
  const searchBoxContainer = document.querySelector('.filter-box.product_filter');
  searchBoxContainer.classList.add('PL017-searchBox_V2');
  ...
  brands.forEach(brand => {
    ...
    if (countBrands < 5) {
      ...
      if (countBrands === 5) {
        pollerLite(['.PL017-middleBanner__wrapper-V2'], () => {
          console.log('add new style on element------');
          document.querySelector('.PL017-middleBanner__wrapper-V2').classList.add('addTopSpacing');
          console.log(document.querySelector('.PL017-middleBanner__wrapper-V2'));
        });  
      }
    }
  });

  const recentlyViewedProductsContainer = `<div class="PL017-products__wrapper_v2">
    <div class="PL017-products__container">
      <div class="PL017-recentlyViewed__header">
        <p>Welcome back, <br> here are your recently viewed products</p>
      </div>
      <div class="PL017-recentlyViewed__products">
        ${recentlyViewedProducts}
      </div>
    </div>
    <div class="PL017-separatingLine"></div>
  ...
  if (!document.querySelector('.PL017-products__wrapper_v2')) {
  ...
  // Middle Banner
  if (!document.querySelector('.PL017-middleBanner__wrapper-V2')) {
    const middleBannerContainer = `<div class="PL017-middleBanner__wrapper-V2"><div class="PL017-middleBanner">
