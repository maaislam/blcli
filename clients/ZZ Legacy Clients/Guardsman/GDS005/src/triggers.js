...
(function () {
  ...
  function PD005() {
    ...
    Replace site logo
    ---------------------------------*/
    $('.siteLogo .cmsimage img').attr('src', '//cdn-sitegainer.com/4ao4sov9j7f8o74.png');
...
// .quick_order /my-account/quickOrder
    ...
    var uspHTML = [
      ['Give your business The Advantage', '<a href="/Advantage?utm_source=Homepage_Desktop&utm_medium=Banner&utm_campaign=Advantage_Mini_200918">FIND OUT MORE HERE</a>', '<img src="//cdn-sitegainer.com/s3vzd0tnyinso30.png" />'],
      ['<b>Free</b> Delivery over £100', 'FREE NEXT DAY DELIVERY AS WELL! GET IT TOMORROW', '<img src="https://d191y0yd6d0jy4.cloudfront.net/9axj7zi7usaxyxn.png" />'],
      ['Contact us on <b>0116 253 86 88</b>', 'MONDAY TO FRIDAY BETWEEN 8:30AM & 5:00PM', '<img src="https://d191y0yd6d0jy4.cloudfront.net/i8jil76k3fa0s3m.png "/>']
    ]
   ...
   var clearanceBar = $('<div class="pd5-clearancewrapper"></div>');
...
---------------------------------*/
    ...
    if (loggedIn.length) {
      ...
      // insert quote button, markup taken form website
     document.getElementById('header').classList.add('PD005_Logged_Out');
     document.getElementById('cart_header').insertAdjacentHTML('afterend', `
     <ul class="PD005_View_Quote_Container">
      <li>
        <p>
          <a href="/cart" class="autodisable">View Quote Basket</a>
          </p>
      </li>
    </ul>
     `);
