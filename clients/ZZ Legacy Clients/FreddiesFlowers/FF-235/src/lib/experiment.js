...
const handleRedirect = () => {
  ...
  window.ga(trackerName + '.send', 'event', 'Experimentation', 'FreddiesFlowers - FF-235', 'Code Redirect', {
...
const handleExperiment = () => {
  ...
  console.log("handled and TR: "+toRedirect);
    if (toRedirect) {
        handleRedirect();
    } else {
...
export default () => {
    ...
    if (shared.VARIATION == 'control') {
      let message = "Visible - experiment fired on control";
