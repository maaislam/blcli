/**
 * NE-422 - PLP dead-end Gift Finder routing
 *
    ...
    if(banner) {
      banner.insertAdjacentHTML('afterbegin', `
        <a href="https://www.neomorganics.com/pages/find-a-feel-good-gift" class="${ID}-banner__inner">
          <h3><strong>Gift Finder</strong> <span>Not sure what gift to give?</span> <span class="small">Answer 4 questions and we’ll help you find the Perfect gift with true wellbeing purpose (it only takes 2 minutes)</span></h3>
