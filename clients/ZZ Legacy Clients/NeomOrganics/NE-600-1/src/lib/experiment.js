...
export default () => {
	...
	if (VARIATION == "1") {
		addNewContentBlock(
			"https://www.neomorganics.com/products/the-night-in-with-neom-box",
			"https://blcro.fra1.digitaloceanspaces.com/NE-600/static-1.jpg"
		);
		addNewContentBlock(
			"https://www.neomorganics.com/products/the-night-in-with-neom-box",
			"https://blcro.fra1.digitaloceanspaces.com/NE-600/static-2.jpg"
		);
	} else {
		addNewContentBlock(
			"https://www.neomorganics.com/products/the-night-in-with-neom-box",
			"https://blcro.fra1.digitaloceanspaces.com/NE-600/gif-1.gif"
		);
	}
