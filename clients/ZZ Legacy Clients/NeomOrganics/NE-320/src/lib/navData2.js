const data = [
  {
    name: 'Shop & Save',
    link: '/collections/supercharged-collections-with-a-saving',
    hasSubmenu: false,
  },
  {
    name: 'Best Sellers',
  ...
  },
  {
    ...
    children: [
      {
        name: 'Discover The Pod Family',
        link: '/pages/the-wellbeing-pod-family',
      },
      {
        name: 'Wellbeing Pod Luxe',
        image: '//c.zmags.com/assets/images/61605fb7a3dd511e9639ec00_300x300.jpeg',
        link: '/collections/wellbeing-pod-luxe',
      },
      {
        name: 'Wellbeing Pod',
      ...
      {
        name: 'Wellbeing Pod Mini',
        image: 'https://c.zmags.com/assets/images/6082d69a7826492627564c00_300x300.jpeg',
        link: '/collections/the-wellbeing-pod-mini',
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'Super Shower Power Body Cleanser',
        image: 'https://cdn.shopify.com/s/files/1/0028/2568/3008/products/SuperShowerPower500ml_750x750.jpg?v=1626254827',
        link: '/collections/super-shower-power-body-cleanser',
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'Overnight Facial',
        image: 'https://cdn.shopify.com/s/files/1/0028/2568/3008/products/PNSOvernightFacialCreamBox_Product_LidOn_750x750.jpg?v=1629881427',
        link: '/collections/perfect-nights-sleep-overnight-facial-cream',
      },
      {
  ...
  {
    name: 'Wellbeing Needs',
    hasSubmenu: true,
    children: [
      {
        name: 'Shop All Wellbeing Needs',
        image: '',
        link: '/collections/wellbeing-fragrances'
      },
      {
        name: 'Better Sleep?',
        image: 'https://ucds.ams3.digitaloceanspaces.com/NE-320/Sleep_Marketing_Panel_8fbd2201-9fb3-4da1-8ec9-8c5ecc1702cc_768x%201.png',
        link: '/collections/wellbeing-fragrances'
      },
      {
        name: 'Less Stress?',
        image: 'https://ucds.ams3.digitaloceanspaces.com/NE-320/De-stress_Marketing_Panel_661f352a-e5d5-4d3f-ac6d-cbba3e7f7c0b_768x%201.png',
        link: '/collections/wellbeing-fragrances'
      },
      {
        name: 'Mood Boost?',
        image: 'https://ucds.ams3.digitaloceanspaces.com/NE-320/Happiness_Marketing_Panel_75666e4d-d18c-4ede-903f-624ec20f63a7_768x%202.png',
        link: '/collections/wellbeing-fragrances'
      },
      {
        name: 'More Energy?',
        image: 'https://ucds.ams3.digitaloceanspaces.com/NE-320/Energy_UK_Marketing_Panel_994f9481-e4a0-4c5d-885a-56f4da526ad0_768.png',
        link: '/collections/wellbeing-fragrances'
      }
    ],
  },
