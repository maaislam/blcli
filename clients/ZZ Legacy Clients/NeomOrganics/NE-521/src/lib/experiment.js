/**
 * NE-521 - V-day PLP Product Recs Carousel
 *
...
const getMarkup = () => {
  ...
  // } 
  if (VARIATION == '1') {
    // data = window.data1[url];
    data = data1['collections'];
  } 
  ...
  // let plpHeader = headers[url];
  let plpHeader = `<span>Feel-Good</span> 
  <span>Valentine’s </span>
  <span class="${ID}-font-madelyn">Gifts</span>`;
