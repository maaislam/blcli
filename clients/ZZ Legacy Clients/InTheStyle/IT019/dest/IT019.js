    ...
    function init(){
		...
		var basketMessaging = {
			...
			contentBuilder: function(){
				...
				cacheDom.deliveryBlock.append('<tr class="IT019-title_message"><td colspan="2">Not at home in the day? A convenient delivery address in the checkout - sorted</td></tr>');
			}
		};
