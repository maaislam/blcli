    ...
    var IT007 = (function() {
            ...
            $('body .off-canvas-wrap').after([
                '<div class="IT_pop-up_modal">',
                    ...
                    '<div class="IT_inner-modal">',
                        ...
                        //  'You\'ve got nothing to lose! Order today and get it tomorrow with Next Day Delivery</div>',
        ...
            }
            ...
            if (slideQ === false) {
                $(".IT_pop-up_modal .IT_close_btn").on("click", function (e) {
                    ...
                    if (modal.hasClass("active")) {
                        modal.fadeOut("slow", function () {
                            ...
                            slideQ = false;
                            sendEvent('IT007--v3', 'user-closed-complete-look-modal', true);
                        });
                    } else {
                ...
                sendEvent('IT007--v3', 'user-added-original-product-page-item-to-basket', true);
                
                if(origSizeOption.length > 0){
                    UC.poller([
                        '.IT_slider.slick-initialized.slick-slider'
                    ], function () {
            ...
            $('.product-collateral .block-related.block-product-grid .products-grid > li').each(function(){
                ...
                if(itemWrap.find('div.price-box .special-price').length > 0){
                    productPrice = itemWrap.find('div.price-box .special-price span.price').text();
                }

                modalSlider.append([
                    '<div class="IT_slide">',
                        '<a href="' + productHref + '" class="IT_href IT_href-follow-product">',
            ...
            $('.IT_href-follow-product').on('click', (e) => {
                sendEvent('IT007--v3', 'modal-product-visited', $(e.currentTarget).attr('href'), true);
            });
            ...
            function addToCartAjax(data, sizeData, sizesNum) {
                ...
                $.ajax({
                    ...
                    data: data,
                    success: function(data) {
                        sendEvent('IT007--v3', 'user-added-product-to-cart', true);

                        modal.fadeOut("slow", function () {
                            modal.removeClass("active");
                            bodyVar.removeClass('IT_checkout_hide');
                            sendEvent('IT007--v3', 'modal-hidden-after-adding-product-to-basket', true);
                        });
                    },
                    error: function() {
                        sendEvent('IT007--v3', 'error-adding-product-to-cart', true);
