    ...
    var IT007 = (function() {
        ...
            }
            ...
            if (slideQ === false) {
                $(".IT_pop-up_modal .IT_close_btn").on("click", function (e) {
                    ...
                    if (modal.hasClass("active")) {
                        modal.fadeOut("slow", function () {
                            ...
                            slideQ = false;
                            sendEvent('IT007--v2', 'user-closed-complete-look-modal', true);
                        });
                    } else {
                ...
                sendEvent('IT007--v2', 'user-added-original-product-page-item-to-basket', true);
            ...
            $('.IT_href-follow-product').on('click', (e) => {
                sendEvent('IT007--v2', 'modal-product-visited', $(e.currentTarget).attr('href'), true);
            });
            ...
            basketBtn.each(function(){
                ...
                $(this).on('click', function(){
                    var el = $(this);
                    var elSliderParent = el.closest('.IT_slide');
                    ajaxLoader.fadeIn();
            ...
            function addToCartAjax(data, sizeData, sizesNum) {
                ...
                $.ajax({
                    ...
                    data: data,
                    success: function(data) {
                        sendEvent('IT007--v2', 'user-added-product-to-cart-moved-to-checkout', true);
                        window.location = '/checkout/cart';
                    },
                    error: function() {
                        sendEvent('IT007--v2', 'error-adding-product-to-cart', true);
