...
// ---------------------------------------------
 UC.poller([
    ...
    (function () {
        ...
        if(window.location.href.indexOf('inthestyle.com/us') > -1) {
          generateTable($usSizes, $bustInchArray, $waistInchArray, $hipsInchArray, productSizes(), $usSizes);
        } else if(window.location.href.indexOf('inthestyle.com/au') > -1) {
          generateTable($auSizes, $bustInchArray, $waistInchArray, $hipsInchArray, productSizes(), $auSizes);
        } else if(window.location.href.indexOf('inthestyle.com/eu') > -1) {
          generateTable($euSizes, $bustInchArray, $waistInchArray, $hipsInchArray, productSizes(), $euSizes);
        } else {
        ...
        var $dropdownHTML = $([
            ...
            '<div class="IT032_dropwdown_option IT032_dropdown_option--us">US</div>',
            '<div class="IT032_dropwdown_option IT032_dropdown_option--au">AU</div>',
            '<div class="IT032_dropwdown_option IT032_dropdown_option--eu">EU</div>',
            '</div>'
        ].join(''));
        ...
        $dropdownOptions.on('click', '.IT032_dropwdown_option', function () {
            ...
            if(window.location.href.indexOf('inthestyle.com/us') > -1) {
              updateCountrySizes(countryShort[$currentText], productSizes(), $usSizes);
            } else if(window.location.href.indexOf('inthestyle.com/au') > -1) {
              updateCountrySizes(countryShort[$currentText], productSizes(), $auSizes);
            } else if(window.location.href.indexOf('inthestyle.com/eu') > -1) {
              updateCountrySizes(countryShort[$currentText], productSizes(), $euSizes);
            } else {
              updateCountrySizes(countryShort[$currentText], productSizes(), $ukSizes);
            }
        });
    ...
    $('.IT032_dropwdown_option').on('click', function(e) {
        // location.hash = '#IT032_anchor'; // bc its is laif
        // Fix

        if($(this).hasClass('IT032-prev-scroll')) {
          $(this).removeClass('IT032-prev-scroll');

          return;
        }

        var myAnchor = $('#IT032_anchor').offset().top;
    ...
    // Set default depending on country
    if(window.location.href.indexOf('inthestyle.com/us') > -1) {
      $('.IT032_dropdown_option--us').addClass('IT032-prev-scroll').trigger('click');
    }
    if(window.location.href.indexOf('inthestyle.com/au') > -1) {
      $('.IT032_dropdown_option--au').addClass('IT032-prev-scroll').trigger('click');
    }
    if(window.location.href.indexOf('inthestyle.com/eu') > -1) {
      $('.IT032_dropdown_option--eu').addClass('IT032-prev-scroll').trigger('click');
    }
