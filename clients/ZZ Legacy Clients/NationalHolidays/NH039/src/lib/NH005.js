...
const NH005 = () => {
  (function() {
    ...
    window._NH005 = function () {
        ...
        var eventSender = events.setDefaultCategory('NH039---Seating Plan Improvements');
        ...
        var run = function run() {
            ...
            /**
             * If on Itinerary page, no seat choice functionality is needed
             */
            var page = window.location.pathname;
            var thisPage = page.split('/')[1];
