...
import reviewsHtml from './html/reviews';
import additionalInfo from './html/additional-info';
...
const nh05 = () => {
  ...
  var run = function run() {
      ...
      $('.nh5-init-live-chat').on('click', function () {
          return $('.header-left .live-chat').click();
      });
