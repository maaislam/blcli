const infiniteScroll = () => {
    ...
    const NH016 = (() => {
        ...
        const activate = () => {
            ...
            //     filterDup.setAttribute('class', 'nh16-new-filter');
            ...
            // sortByWrap.setAttribute('class', 'nh16-sortby-wrap');
            // if (sortBy) {
            ...
            // newDiv.setAttribute('class', 'container nh16-new-results');
            
            
            // // Create filter button 
            // var newBtn = document.createElement('a');
            // newBtn.setAttribute('class', 'nh16-new-filter-btn l-blue-btn');
            // newBtn.textContent = "Filter";
            
            // // Create filter tooltip
            // var tooltip = document.createElement('div');
            // tooltip.setAttribute('class', 'nh16-filter-tooltip');
            ...
            //         let h4WithClass = h4Wrap.classList.add('nh16-filter-item-' + i);
            //         let filterWithClass = activeFilter[i].classList.add('nh16-filter-item-' + i);
            ...
            // if (VARIATION == 2) {
                pagContainer.classList.add('nh16-pag-styles');
            ...
            noMore.classList.add('NH16-no-more'); 
                            ...
                            if (html) {
                                ...
                                for (let j = 0; nextPosts.length > j; j++) {
                                    ...
                                    tourBtn.addEventListener("click", function(e) {
                                        e.preventDefault();
                                        window.location.href = infoLink + "#nh16moredates";
                                    });
        ...
        // if (window.location.hash == '#nh16moredates') {
