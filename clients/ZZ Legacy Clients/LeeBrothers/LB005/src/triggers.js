...
(function () {
  ...
  function PD005() {
    ...
    $('.La.sales_helpline').html('<span><b>Sales Helpline: </b>0121 567 4111</span>').prependTo(headerTopelements);
    /*-------------------------------
    Replace site logo
    ---------------------------------*/
...
// .quick_order /my-account/quickOrder
    ...
    var uspHTML = [
      ...
      ['<b>Free</b> Delivery over £50', 'FREE NEXT DAY DELIVERY AS WELL! GET IT TOMORROW', '<img src="//cdn-sitegainer.com/c1vxd335jny25at.png" />'],
      ['Contact us on <b>0121 567 4111</b>', 'MONDAY TO FRIDAY BETWEEN 8:00AM & 5:30PM', '<img src="//cdn-sitegainer.com/doedvhwixqw7l5b.png"/>']
    ]
