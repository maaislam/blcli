 ...
 * IDXXX - Description
 */
import { setup, getUserData, fireEvent } from './services';
    ...
    addPoller(['local-basket-add-notice upsell-products-item action'], () => {
      [].forEach.call(document.querySelectorAll('upsell-products-item action'), (l) => {
        l.addEventListener('click', () => {
          fireEvent('addons-added-to-basket');
        });
      });
    });
  }
              ...
              items.map(p => {
                return `
                  <div class="${ID}-addons__item" data-id="${p.id}">
                    ...
                    <a class="${ID}-addons__item-imageholder" href="${p.link}">
                      <img src="${p.img}" alt="${p.name} image" class="${ID}-addons__item-img" />
                    </a>
    ...
    [].forEach.call(checkoutBtns, (checkoutBtn) => {
      if(checkoutBtn) {
        checkoutBtn.addEventListener('click', (e) => {
          fireEvent('clicked-checkout-btn');
        });
      }
    });
    ...
    [].forEach.call(contBtns, (contBtn) => {
      if(contBtn) {
        contBtn.addEventListener('click', (e) => {
          ...
          fireEvent('clicked-continue-btn');
  ...
  return [
    {
      ...
      items: [
        ...
        {
          id: 1486,
          link: 'https://www.biscuiteers.com/shop/mini-gin-1-1284',
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/t/r/tregothnan_for_biscuiteers_afternoon_tea_pouch.jpg',
          price: '5.00',
...

        {
          id: 1485,
          link: 'https://www.biscuiteers.com/shop/mini-gin-1-1284',
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/t/r/tregothnan_for_biscuiteers_great_british_tea.jpg',
          price: '5.00',
...

        {
          ...
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/z/i/zing_negroni_new_label.jpg',
          price: '9.50',
        ...
        },
        {
          ...
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/r/h/rhubarb_and_rose.jpg',
          price: '9.50',
        ...
        },
        {
          ...
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/s/a/salted_caramel_martini_new_label.jpg',
          price: '9.50',
        ...
        },
        {
          ...
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/p/i/pineapple_and_ginger_mojito_new_label.jpg',
          price: '9.50',
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 1016,
          link: 'https://www.biscuiteers.com/mini-prosecco',
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/h/a/hamper_3_1.jpg',
          price: '10.00',
...

        {
          ...
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/b/i/biscuiteers_tea_towel_2.jpg',
          price: '10.00',
        ...
        },
        {
          ...
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/c/u/cutout_-_tote_bag_shopper_-_low_res_1.jpg',
          price: '10.00',
    ...
    },
    {
      ...
      items: [
        
        {
          ...
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/w/_/w.jpg',
          price: '22.00',
          name: 'Prosecco'
        },

        {
          ...
          img: 'https://thumbor-gc.tomandco.uk/unsafe/trim/fit-in/769x577/filters:upscale():fill(white)/https://www.biscuiteers.com/static/media/catalog/product/g/u/gusbourne_2.jpg',
          price: '50.00',
...
const onClickAddToCart = () => {
  ...
  if(addonsSelectedDesktop > 0) {
    fireEvent('addons-added-to-basket: '+addonsSelectedDesktop);
  }
