        ...
        <div class="bi15b-upsell-wrapper bi15b-upsell-wrapper--basket">
          <div class="wrap">
            <div class="bi15b-banner__intro">
              <span class="bi15b-banner__text3">Don't forget it's Father's Day on 17th of June</span>
            </div>
            <div class="bi15b-banner__upsells">
              <h2>Don't forget Father's Day 17th <span class="bi15-ttinitial">June</span></h2>
              <p class="bi015b-choose-date">
                Order now for delivery closer to the big day
              </p>
    ...
    config.upsellProducts.forEach((prod) => {
      upsellWrap.insertAdjacentHTML('beforeend', `
        <div class="bi15b-banner__upsell-item">
          <a href="${prod.url}" title="${prod.name} - £${prod.price}" data-bi15bid="${prod.id}">
            <img src="${prod.image}" />
          </a>
