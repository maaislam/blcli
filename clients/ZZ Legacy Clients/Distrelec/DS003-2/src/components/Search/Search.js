...
export default class Search {
  ...
  create() {
    ...
    element.innerHTML = `
      <div class="${ID}_wordCarouselWrap">
        <div class="${ID}_wordCarousel">
          <div class="${ID}_wordCarousel__content rotateword">
            Search for
            <span></span>
          </div>
        </div>
      ...
      <div class="${ID}_Search__formContainer">
        <div class="${ID}_Search__form">
          <div class="${ID}_Search__formBlock">
            <div class="${ID}_Search__filterWrap">
              <select class="${ID}_Search__filter">
                ${this.categoryIDs.map(category => `<option value="${category.ID}">${category.name}</option>`)}          
              </select>
            </div>
      ...
      <div class="${ID}_recentSrcWrap">
        <div class="${ID}_recentSrc">
          ${this.recentSearches.length ? '<span>Your recent searches:</span>' : ''}
    ...
    // Move the overlay
    const overlay = searchBar.querySelector('.overlay-suggest');
