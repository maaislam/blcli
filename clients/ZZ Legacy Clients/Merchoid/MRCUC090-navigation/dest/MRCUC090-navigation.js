...
$(function () {
    ...
    var newNav = $([
    '<div class="uc090_mobilenav_wrap">',
        //'<div class="uc090_message">Message</div>',
        '<div class="uc090-button clearfix">',
                '<div class="uc090_mobnav_button brands">', '<div class="uc090but-title brands active">',
                        'Brands',
                    '</div>',
                '</div>',
    ...
    $('.shiftnav .shiftnav-inner').replaceWith(newNav);
    ...
    //Markup
    var Links = $([
                '<div class="uc090-links brands active arrow_box">',
                    '<div class="uc-link">',
                    ...
                    '</div>',
                '</div>',
                '<div class="uc090-links clothing">',
                    '<div class="uc-link">',
                   ...
                   '<div class="uc-link">',
                    ...
                    '</div>',
                    '<div class="uc-link">',
                        '<img src="' + imagesLink.toys + '"/>',
                        '<a href="' + clothingLinks.toysLink + '">Toys</a>',
                        '<img class="uc90-arrow" src="//cdn.optimizely.com/img/6269321863/df24de405caf4dd79664ae3c83e054db.png"/>',
                    '</div>',
                    '<div class="uc-link">',
                        '<img src="' + imagesLink.figures + '"/>',
                        '<a href="' + clothingLinks.figuresLink + '">Figures & Plushies</a>',
                        '<img class="uc90-arrow" src="//cdn.optimizely.com/img/6269321863/df24de405caf4dd79664ae3c83e054db.png"/>',
                    '</div>',
                    '<div class="uc-link">',
                        '<img src="' + imagesLink.homeofficeimg + '"/>',
                        '<a href="' + clothingLinks.homeofficeLinkk + '">Home & Office</a>',
                        '<img class="uc90-arrow" src="//cdn.optimizely.com/img/6269321863/df24de405caf4dd79664ae3c83e054db.png"/>',
                    '</div>',
                '</div>'
    ...
    $('.uc090_mobnav_button.clothing').click(function () {
        $('.uc090-links.brands').removeClass('active');
        $('.brands.uc090but-title').removeClass('active');
        $('.uc090-links.clothing').addClass('active');
        $('.uc090_mobnav_button.brands').removeClass('active');
        $(this).addClass('active');
        $('.uc090-links.brands').removeClass('arrow_box');
        $('.uc090-links.clothing').addClass('arrow_box');
    });

    $('.uc090_mobnav_button.brands').click(function () {
        $('.uc090-links.clothing').removeClass('active');
        $('.uc090-links.brands').addClass('active');
        $('.uc090_mobnav_button.clothing').removeClass('active');
        $('.uc090-links.clothing').removeClass('arrow_box');
        $('.uc090-links.brands').addClass('arrow_box');
        $(this).addClass('active');
    });
