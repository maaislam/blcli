...
/**
 * {{ME170}} - {{Christmas Price Framing V3}}
 */
    ...
    render: {
      productText() {
        ...
        <div class="ME170_Container">
          <span class="ME170_Text">Stand out at the Christmas Party This Year With Our<span class="ME170_Bold"> 100% Genuine </span><img class="ME170_Image" src="${Exp.cache.logoSRC}" alt="${Exp.cache.logoAlt} Logo" />Christmas ${descriptionText}</span>
        </div>
        `);
      },
    },
