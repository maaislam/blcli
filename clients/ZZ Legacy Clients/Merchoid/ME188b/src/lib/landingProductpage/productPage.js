...
export default () => {
  ...
  const genuineMessage = () => {
    ...
    100% genuine
      <img src="https://merchoid-pveiw4zwh96ot9z.netdna-ssl.com/wp-content/uploads/2017/05/Star-Wars-Logo-PNG-Image.png">
    merchandise`;
  };
  ...
  const featuresSection = () => {
    ...
    features.innerHTML = `
      <h2>Key Features</h2>
      <p>"You know, sometimes I amaze even myself" <span>- Han Solo</span></p>
  ...
  const smoothScroll = () => {
    ...
    for (let index = 0; index < anchorLinks.length; index += 1) {
      ...
      element.addEventListener('click', (e) => {
        ...
        } else if (e.target.href.indexOf(`${settings.ID}-buy`) > -1) {
        ...
        } else if (e.target.href.indexOf(`${settings.ID}-features`) > -1) {
