...
export default () => {
    ...
    if (!getCookie(`${ID}-emailSignUp`)) {
        ...
        mailIcon.classList.add(`${ID}-mail`);
        mailIcon.innerHTML = `<span></span>`;
        mobileHeader.querySelector('.header-right-links__cart-links').insertAdjacentElement('afterbegin', mailIcon);
    }
