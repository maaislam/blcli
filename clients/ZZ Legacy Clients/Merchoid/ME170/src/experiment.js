...
/**
 * {{ME170}} - {{Christmas Price Framing V1}}
 */
    ...
    render: {
      productText() {
        ...
        <div class="ME170_Container">
          <span class="ME170_Text">Treat Yourself This Christmas & Wrap Up Warm With Our<span class="ME170_Bold"> 100% Genuine </span><img class="ME170_Image" src="${Exp.cache.logoSRC}" alt="${Exp.cache.logoAlt} Logo" />Christmas ${descriptionText}</span>
        </div>
        `);
      },
    },
