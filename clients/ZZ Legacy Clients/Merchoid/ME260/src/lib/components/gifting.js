...
export default () => {
    ...
    const addBestSellers = () => {
        ...
        Object.keys(bestSellerProducts).forEach((i) => {
            ...
            <div class="product-item-info">
                ...
                document.querySelector(`.${ID}-bestSellers .${ID}-productsContent`).appendChild(productBlock);
        });
    }
    ...
    const createBrandCarousel = () => {
        ...
        Object.keys(topBrands).forEach((i) => {
            ...
            document.querySelector(`.${ID}-section.${ID}-brands .${ID}-carousel`).appendChild(giftBrand);
        });
    ...
    // slick brands
    const slickBrands = () => {
        jQuery(`.${ID}-carousel.${ID}-innerBlocks`).slick({
            dots: false,
            mobileFirst: true,
            slidesToShow: 2,
            arrows: true,
