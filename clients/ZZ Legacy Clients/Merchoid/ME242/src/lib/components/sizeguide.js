...
class Lightbox {
  ...
  bindEvents() {
    ...
    const sizeLink = document.querySelector(`.${shared.ID}-sizeGuideLink`);
...
const addSizeGuideText = () => {
    ...
    const sizeOption = document.querySelector('.product-options-wrapper .label');
    sizeOption.insertAdjacentElement('afterend', sizeLink);
  }
