...
var _ME126 = (function() {
    ...
    var _activate = function() {
        ...
        function inGridContent(){
            ...
            headingName.each(function(){
                ...
                var inGridblocks = [
                    ['Be the hit of your Christmas party'],
                    ['Keeps you warm all winter'],
                    ['Show off your amazing tastes'],
                    ["Get ready to hear 'Where did you get that!?'"],
                    ['Feel unique this Christmas']
    ...
    var _triggers = function(options) {
        utils.fullStory('ME126', 'Variation 3');
