...
export default () => {
  ...
  secondEmailBox.classList.add('ME178-email_wrapper_bottom');
  secondEmailBox.innerHTML = `<p>
  Be the first to hear about out latest Christmas ${jumperText} releases. Join our newsletter today
  </p>
  <div class="ME178-success">Thankyou for signing up!</div>
  <div class="ME178-email_box">
  ...
  pollerLite(['.ME178-email_box'], () => {
    ...
    const bottomForm = document.querySelector('.ME178-email_wrapper_bottom .ME178-email_box');
    ...
    const succesBottom = document.querySelector('.ME178-email_wrapper_bottom').querySelector('.ME178-success');
