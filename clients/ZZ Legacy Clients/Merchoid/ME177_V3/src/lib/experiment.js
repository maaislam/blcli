...
/**
 * {{ME177}} - {{Product Imagery Messaging V3}}
 */
  ...
  const Exp = {
    ...
    services: {
      getImages: () => {
        ...
        Exp.cache.messageArray = [`Premium ${brandName} ${productTypeText}`, `Design Approved By The ${brandName} Franchise`, 'Don\'t Miss Out. Buy Yours Now'];
        // Cache images
