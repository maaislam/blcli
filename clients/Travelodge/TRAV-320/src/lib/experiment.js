...
const checkForExtrasInRate = () => {
  ...
  if(allRoomsHaveBreakfast) {
    ...
    // roomTypeText.forEach((room) => {
    //   if(room.includes('standard room plus')) {
...
const startExperiment = () => {
  ...
  pollerLite(['.bookNow'], () => {
    let currBookNow = document.querySelector('.bookNow');
    ...
    let newBookNowButton = document.getElementById(`${ID}-booknow`);
