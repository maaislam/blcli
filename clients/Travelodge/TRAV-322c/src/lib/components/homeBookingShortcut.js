            ...
            <div class="${ID}-home-booking-shortcut-body">
                ...
                <div class="${ID}-home-booking-shortcut-body-right">
                    ${bookingObj.rooms.map((room, index) => {
                        const bookingLink = `https://www.travelodge.co.uk/manage-bookings?confirmationNumber=${room["confirmationNumber"]}&surname=${bookingObj.surname}&journey=share`;
                        return `
