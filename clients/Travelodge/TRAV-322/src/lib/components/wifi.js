const wifi = (ID) => {
   const wifiPrices = {
    ...
    const bookingLink = `https://www.travelodge.co.uk/manage-bookings?confirmationNo=${confirmationNumber}&surName=${bookingSurname}&journey=wifi`
    const isStaging = window.location.hostname.includes('int.dev');
    const stagingBookingLink = `https://int.dev.travelodge.co.uk/manage-bookings?confirmationNo=${confirmationNumber}&surName=${bookingSurname}&journey=wifi`
        ...
        <div class="${ID}-wifi-container">
            <div class="${ID}-wifi-container-left ${ID}-wifi-container-sub">
                ...
                <div class="${ID}-wifi-logo ${ID}-hide-desktop">
                    ...
                    <img src="https://blcro.fra1.digitaloceanspaces.com/TRAV-322/trav-322-virgin.png" alt="Virgin Media">
                </div>
            </div>
