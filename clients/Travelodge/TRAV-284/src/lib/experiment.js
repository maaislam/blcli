...
const startExperiment = () => {
  ...
  if (currRecentlyViewed.length < 5) {
    ...
    getHotelData(lastViewed.id).then((hotelData) => {
      ...
      let nearbyHotels = hotelData["algo:items:Nearby Hotels"].split("|");
            ...
            nearbyHotels.map((item, index) => {
                if(index < difference){
                  ...
                  if (searchedCheckinDate < todayDate) {
                    ...
                    let newURLString = item;
                    newURLString = item.replace(currRecentlyViewedItem.checkIn, nextAvailDateFormatted).replace(currRecentlyViewedItem.checkOut, nextAvailDateFinalFormatted);
                   ...
                   <a href="${newURLString}" class="${ID}-recently-viewed--containeritem">
                     <img src="https://media.travelodge.co.uk/image/upload/ecrm/hotels-digi/${item}.jpg">
                     <p>${theDateString}</p>
                   </a>
                  `;
                    ...
                    theHTMLString = `
                   <a href="${item}" class="${ID}-recently-viewed--containeritem">
                     <img src="https://media.travelodge.co.uk/image/upload/ecrm/hotels-digi/${item}.jpg">
                     <p>${theDateString}</p>
                   </a>
                  `;
