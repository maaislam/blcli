            ...
            <div class="${ID}-home-booking-shortcut-body">
                ...
                <div class="${ID}-home-booking-shortcut-body-right">
                    ${bookingObj.rooms.map((room, index) => {
                        const bookingLink = `${isStaging ? 'uat.dev' : 'https://www'}.travelodge.co.uk/manage-bookings?confirmationNo=${room["confirmationNumber"]}&surname=${bookingObj.surname}&journey=share`;
                        return `
