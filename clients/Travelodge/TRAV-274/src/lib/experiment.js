    ...
    let modalHTML = `
      <div class="${ID}-extrasmodal ${multipleRooms === true ? `${ID}-multipleroomsactive` : ``}">
        ...
        <div class="${ID}-extrasmodal--subnav">
          ...
          <button class="${ID}-close"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.9393 12L6.9696 15.9697L8.03026 17.0304L12 13.0607L15.9697 17.0304L17.0304 15.9697L13.0607 12L17.0303 8.03039L15.9696 6.96973L12 10.9393L8.03038 6.96973L6.96972 8.03039L10.9393 12Z" fill="#000"/></svg></button>
          ...
          <div class="${ID}-extras ${breakfastType}">
            ...
            <div class="${ID}-extras--holder">
              ...
              ${breakfastType == 'unlimitedbreakfast' ? `
                ...
                <div id="${ID}-extra-unlimitedbreakfast" class="${ID}-extra ${ID}-hero ${ID}-extra-unlimitedbreakfast">
                  ...
                  <div class="${ID}-extra--header">
                    ...
                    ${kidsBooking == true ? 
                      `<span class="${ID}-kidseatfree">Kids eat free</span>` : 
                  ...
                  <div class="${ID}-extra--content">
                    ...
                    <div class="${ID}-extra--contentinner">
                      ...
                      <button class="${ID}-button" data-extratype="breakfast"><span class="${ID}-addedtext">Added</span>${multipleRooms == true ? `<span class="${ID}-addtext">Add to all</span>` : `<span class="${ID}-addtext">Add</span>`} | <span id="${ID}-unlimitedbreakfast-totalbuttonamount">${totalBreakfastPriceString}</span> total</button>
                    </div>
                ...
                <div id="${ID}-extra-breakfasttogo" class="${ID}-extra ${ID}-extra-breakfasttogo">
                  ...
                  <div class="${ID}-extra--content">
                    ...
                    <div class="${ID}-extra--contentinner">
                      ...
                      <button class="${ID}-button" data-extratype="breakfast"><span class="${ID}-addedtext">Added</span>${multipleRooms == true ? `<span class="${ID}-addtext">Add to all</span>` : `<span class="${ID}-addtext">Add</span>`} | <span id="${ID}-wifi-totalbuttonamount">${totalBreakfastPriceString}</span> total</button>
                    </div>
              ...
              <div id="${ID}-extra-wifi" class="${ID}-extra ${ID}-extra-wifi">
                ...
                <div class="${ID}-extra--content">
                  ...
                  <div class="${ID}-extra--contentinner">
                    ...
                    <button class="${ID}-button" data-extratype="wifi"><span class="${ID}-addedtext">Added</span>${multipleRooms == true ? `<span class="${ID}-addtext">Add to all</span>` : `<span class="${ID}-addtext">Add</span>`} | <span id="${ID}-wifi-totalbuttonamount">${totalWifiPriceString}</span> total</button>
                  </div>
              ...
              <div id="${ID}-extra-dinner" class="${ID}-extra ${ID}-extra-dinner">
                ...
                <div class="${ID}-extra--content">
                  ...
                  <div class="${ID}-extra--contentinner">
                    ...
                    <button class="${ID}-button" data-extratype="dinner"><span class="${ID}-addedtext">Added</span>${multipleRooms == true ? `<span class="${ID}-addtext">Add to all</span>` : `<span class="${ID}-addtext">Add</span>`} | <span id="${ID}-dinner-totalbuttonamount">${totalDinnerPriceString}</span> total</button>
                  </div>
              ...
              <div id="${ID}-extra-earlycheckin" class="${ID}-extra ${ID}-extra-earlycheckin">
                ...
                <div class="${ID}-extra--content">
                  ...
                  <div class="${ID}-extra--contentinner">
                    ...
                    <button class="${ID}-button" data-extratype="earlyIn"><span class="${ID}-addedtext">Added</span>${multipleRooms == true ? `<span class="${ID}-addtext">Add to all</span>` : `<span class="${ID}-addtext">Add</span>`} | <span id="${ID}-earlycheckin-totalbuttonamount">${totalEarlyCheckInPriceString}</span> total</button>
              ...
              <div id="${ID}-extra-latecheckout" class="${ID}-extra ${ID}-extra-latecheckout">
                ...
                <div class="${ID}-extra--content">
                  ...
                  <div class="${ID}-extra--contentinner">
                    ...
                    <button class="${ID}-button" data-extratype="lateOut"><span class="${ID}-addedtext">Added</span>${multipleRooms == true ? `<span class="${ID}-addtext">Add to all</span>` : `<span class="${ID}-addtext">Add</span>`} | <span id="${ID}-latecheckout-totalbuttonamount">${totalLateCheckOutPriceString}</span> total</button>
              ...
              <div id="${ID}-extra-pets" class="${ID}-extra ${ID}-extra-pets">
                ...
                <div class="${ID}-extra--content">
                  ...
                  <div class="${ID}-extra--contentinner">
                    ...
                    <button class="${ID}-button" data-extratype="pets"><span class="${ID}-addedtext">Added</span>${multipleRooms == true ? `<span class="${ID}-addtext">Add</span>` : `<span class="${ID}-addtext">Add</span>`} | <span id="${ID}-pets-totalbuttonamount">${totalPetsPriceString}</span> total</button>
...
export default () => {
  ...
  if(window.location.href.indexOf('checkIn') > -1) {
    pollerLite([() => { return window.globalDataLayer.hotelCode != undefined }], () => {
      let dyData;
