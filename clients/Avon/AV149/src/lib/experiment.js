...
export default () => {
  ...
  const productReviewsMobile = document.querySelector('#product-title-mobile .product-title.main-product-title');
  const startClickable = document.querySelector('#product-detail .star-clickable');
  const productSwatchDesktopLists = document.querySelectorAll('#product-detail .product-colour-swatch ul li');
  ...
  const checkMutations = (list) => {
    list.addEventListener('click', () => {
      document.querySelector(`.${ID}__topRatedBadgeWrapper`) && document.querySelector(`.${ID}__topRatedBadgeWrapper`).remove();
      if (
