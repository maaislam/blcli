...
export default class StickyHeader {
  constructor() {
    ...
    this.$ = $;
    this.componentName = `${ID}_SampleCount`;
  ...
  bindEvents() {
    ...
    rootScope.$on('CartService.RemoveProductSuccess', basketChangeHandler);
    rootScope.$on('CartService_ChangeProductQuantitySuccess', basketChangeHandler);
  }
