        ...
        <div class="Button button-add-to-cart vi-btn vi-btn--primary ng-scope ${componentName}AddToCart" ng-class="{'button-add-to-cart-disabled': !hasSelectedVariant()}">
          <div class="button-add-to-cart-content button-add-to-cart-text text-not-selectable">
            <svg-icon icon="basket_pdp" class="ng-isolate-scope">
              ...
              <img class="${componentName}ButtonTickIcon" src="https://service.maxymiser.net/cm/images-eu/avon-mas/A1308CC55218878E7DC3FCDA6EE7BAE71F11705E96221B27CEB23F506CC01C9B.svg?meta=/AWE005b---Hero-PDPs/tick.svg" alt="tick" />
              <span class="${componentName}ButtonTextInitial">Aggiungi al Carrello</span>
              <span class="${componentName}ButtonTextActive">Aggiungi</span>
              <span class="${componentName}ButtonTextActiveDesktop">Aggiungi</span>
             </div>
        </div>
      </div>
    `);
