...
import { getLayoutName, createDateAsUTC } from '../../services';
...
export default class DeliveryMessaging {
  ...
  create() {
    ...
    component.innerHTML = `Guaranteed for Christmas if you order with express delivery in the next <span id="${name}_countdown"></span>`;
  ...
  initCountdown() {
    ...
    if (countdownEl) {
      ...
      let cutoff = createDateAsUTC('December 20, 2019 13:00:00');
