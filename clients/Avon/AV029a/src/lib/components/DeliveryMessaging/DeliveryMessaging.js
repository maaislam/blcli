...
export default class DeliveryMessaging {
  ...
  create() {
    ...
    component.innerHTML = `Guaranteed Christmas delivery if you order in the next <span id="${name}_countdown"></span>`;
  ...
  initCountdown() {
    ...
    if (countdownEl) {
      ...
      let cutoff = createDateAsUTC('December 17, 2019 13:00:00');
