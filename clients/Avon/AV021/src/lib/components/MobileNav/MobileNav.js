...
export default class MobileNav {
  ...
  openNav() {
    ...
    //-- CODE for when nav is OPEN
    if (document.querySelector('.AV021_MobileNav.AV021_MobileNav--open')) {
      document.querySelector('.AV021_MobileNav_overlay.ng-scope').setAttribute('style', 'margin-top: 104px;');
      document.querySelector('.AV021_MobileNav.ng-scope.AV021_MobileNav--open').setAttribute('style', 'top: 104px;');
    }
  }
