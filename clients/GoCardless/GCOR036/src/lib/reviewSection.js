...
<div class="${ID}-reviewSection-top-footer"><a href="javascript:void(0)" class="${ID}-reviewSection-top-CTA css-t8f9yb">Read our reviews</a></div>
</div>`;
...
export const reviewSectionFooter = `<div class="${ID}-reviewSection-footer">
  <h1 class="${ID}-reviewSection-footer-header css-5l3bus">Reviews</h1>
