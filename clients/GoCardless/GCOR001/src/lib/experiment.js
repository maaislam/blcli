...
const v2Copy = `60,000 businesses globally use GoCardless to make payment collection easier. Getting started is free.`;
  ...
  sticky.insertAdjacentHTML(
    ...
    `
      <div class="${ID}_stickyContent">
        <p>Try a better way to collect payments<span class="${ID}_hideMobile">, with GoCardless. It's free to get started.</span></p>
        <div class="${ID}_buttons">
          <a class="${ID}_buttonSecondary" href="https://gocardless.com/solutions/learn-more/">Learn more</a>
          <a class="${ID}_buttonPrimary" href="https://manage.gocardless.com/signup?widget=hook">Sign up</a>
        </div>
      </div>
  `
  );
     ...
     <div class="${ID}_ctaWrapper ${ID}_ctaWrapperMiddle">
        <picture>
          <source
            ...
            srcset="https://brainlabs-media.s3.eu-west-2.amazonaws.com/gc/gc001_mid_mobile.png">
          <source
              media="(min-width: 769px)"
              srcset="https://brainlabs-media.s3.eu-west-2.amazonaws.com/gc/gc001_mid_desktop.png">
          <img src="https://brainlabs-media.s3.eu-west-2.amazonaws.com/gc/gc001_mid_desktop.png" alt="dashboard" />
        </picture>
  ...
  return `
     <div class="${ID}_ctaWrapper ${ID}_ctaWrapperBottom">
        <picture>
          <source
            media="(max-width: 768px)"
            srcset="https://brainlabs-media.s3.eu-west-2.amazonaws.com/gc/gc001_bot_mobile.png">
          <source
              media="(min-width: 769px)"
              srcset="https://brainlabs-media.s3.eu-west-2.amazonaws.com/gc/gc001_bot_desktop.png">
          <img src="https://brainlabs-media.s3.eu-west-2.amazonaws.com/gc/gc001_bot_desktop.png" alt="dashboard" />
        </picture>
        <div class="${ID}_ctaContent">
          <p>${v2Copy}</p>
          <div class="${ID}_buttons">
