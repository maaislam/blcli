...
export default () => {
  ...
  document.body.addEventListener('click', (e) => {
    ...
    if (target.closest('.css-140tqjo')) {
      ...
      if (target.getAttribute('href').includes('https://content.gocardless.com/a-new-era-of-payments-au/what-are-bank-payments-au')) {
        fireEvent('User interacts with the “Read the blog” CTA');
      }

      if (target.getAttribute('href').includes('https://content.gocardless.com/faster-safer-cheaper-au/hidden-payments-costs-au')) {
        fireEvent('User interacts with the “Find out more” CTA');
      }

      if (target.getAttribute('href').includes('https://content.gocardless.com/better-payments-better-business-au')) {
        fireEvent('User interacts with the “Take a look” CTA on the third customer story');
      }
    }

    if (target.closest('.css-1lma31c')) {

      if (target.closest('.css-1lma31c').querySelector('a').getAttribute('href').includes('https://content.gocardless.com/better-payments-better-business-au/uk-deputy')) {
        fireEvent('User interacts with case studies (deputy-case-study)');
      }

      if (target.closest('.css-1lma31c').querySelector('a').getAttribute('href').includes('https://content.gocardless.com/better-payments-better-business-au/fundtap-story')) {
        fireEvent('User interacts with case studies (fundtap-case-study)');
      }

      if (target.closest('.css-1lma31c').querySelector('a').getAttribute('href').includes('https://content.gocardless.com/better-payments-better-business-au/loopit-customer-story')) {
        fireEvent('User interacts with case studies (loopit-customer-case-study)');
      }

      if (target.closest('.css-1lma31c').querySelector('a').getAttribute('href').includes('https://content.gocardless.com/better-payments-better-business-au/dukes-gym')) {
        fireEvent('User interacts with case studies (dukes-gym-case-study)');
      }
    ...
    if (
      ...
      target.getAttribute('href').includes('https://gocardless.com/en-au/contact-sales/')
    ) {
