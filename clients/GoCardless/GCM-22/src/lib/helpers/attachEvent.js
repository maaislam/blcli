const attachEvent = (event, fireEvent, variation) => {
  const possibleUrls = {
    var1: 'https://gocardless.com/de-de/g/gcm0029dach/',
    var2: 'https://gocardless.com/de-de/g/gcm0029dach/',
    control: 'https://gocardless.com/de-de/g/gcm0029dach/',
  };
  ...
  if (event.target.closest(`a[href^="${btnUrl}"]`)) {
    fireEvent(`user clicked the "${ctaText}" button`);
