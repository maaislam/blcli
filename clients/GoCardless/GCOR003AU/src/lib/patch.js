...
//     const oldLearnBtn = document.querySelector('.GCOR003AU_buttonSc.GCOR003AU_ctaSticky');
//     if (oldLearnBtn) {
//       const newLearnUrl = getLearnMoreUrl();
//       console.log(newLearnUrl);
//       if (newLearnUrl && document.querySelectorAll('.GCOR003AU__personalised-btn').length <= 0) {
//         const htmlStr =
//           '<a class="GCOR003AU_buttonSc GCOR003AU__personalised-btn" style="background-color:transparent;color:#fff" href="' +
//           newLearnUrl +
//           '">Learn more</a>';
...
//         document.querySelector('.GCOR003AU__personalised-btn').remove();
//       }
//     } else {
