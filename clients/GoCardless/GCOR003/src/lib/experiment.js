    ...
    sticky.insertAdjacentHTML(
      ...
      <div class="${ID}_stickyContent">
        ...
        <div class="${ID}_buttons">
          ...
          <a class="${ID}_button ${ID}_ctaScSticky" href="https://manage.gocardless.com/signup?widget=hook">Sign up</a>
        </div>
      </div>
  `
    );
    ...
    if (hero && wrapper && !document.querySelector(`.${ID}_ctas`)) {
      ...
      const ctaPanel = `
            <div class="${ID}_ctaWrapperBottom">
              ...
              <div class="${ID}_ctaContent">
                <span class="title">What would you like to do next?</span>
                <div class="${ID}_buttons">
      ...
      setTimeout(() => {
        ...
        if (bottomCta && !document.querySelector(`.${ID}_ctaWrapperBottom`)) {
          ...
          bottomCta = document.querySelector('[data-testid="multiPageGuidePagination"]') || document.querySelector('.css-2mik2o');
          if (bottomCta) {
            bottomCta.insertAdjacentHTML('beforebegin', ctaPanel);
          }
        }
