...
import initWistia from './helpers/addWistia';
...
const init = (mutation) => {
  ...
  const paragraphs = main.querySelector('[data-module-name="articleContent"] .css-h94nr3').getElementsByTagName('p');
...
export default () => {
  ...
  pollerLite(['#___gatsby'], () => {
    ...
    const wistiaUrls = [
      'https://fast.wistia.com/embed/medias/pb0x2kjuf3.jsonp',
