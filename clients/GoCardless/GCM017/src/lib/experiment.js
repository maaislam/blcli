...
const init = (pageData, geo) => {
  ...
  attachPoint.insertAdjacentHTML(placement, banner(ID, pageData, geo));
...
export default (pageData, geo) => {
  ...
  window.addEventListener('scroll', () => {
    ...
    } else if (scrollPercentage <= 10 && webinerContainer.classList.contains('active')) {
