...
export const clickShowTooltip = (parentContainer) => {
  if (parentContainer.querySelector(`.${ID}-most-popular.first`)) {
    parentContainer.querySelector(`.${ID}-most-popular.first`).addEventListener('click', (e) => {
      parentContainer.querySelector(`.${ID}-most-popular.first .${ID}-text`).classList.add('active');

      fireEvent(`Click - Tooltip`);
      fireEvent(`Visible - Tooltip`);
  
      setTimeout(() => {
        parentContainer.querySelector(`.${ID}-most-popular.first .${ID}-text`).classList.remove('active');
      }, 3000);
    });
  }
};
...
export const hoverOverTooltip = (parentContainer) => {
  if (parentContainer.querySelector(`.${ID}-most-popular`)) {
    parentContainer.querySelector(`.${ID}-most-popular.first`).addEventListener('mouseover', (e) => {
