...
import data1 from './lib/data_new';
...
if(!ieChecks) {
  pollerLite([
    ...
    'div#primary_image.productImagePrimary.clickImage',
  ], () => {
    let runExp = false;
    ...
    if (runExp && document.querySelectorAll('.day_price')[1].querySelectorAll('.price-row .price-blk').length > 0) {
      activate();
    }
  });
}
