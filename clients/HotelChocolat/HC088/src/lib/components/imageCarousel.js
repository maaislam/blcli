...
export default class MainImageCarousel {
    ...
    slickImages() {
        ...
        // charcoal
        window.jQuery(`.${ID}-productSlider .${ID}-images`).slick('slickAdd','<img class="HC088-image" attr="472727" src="https://www.hotelchocolat.com/dw/image/v2/AAZP_PRD/on/demandware.static/-/Sites-hotelchocolat-master-catalog/default/dw712394ec/images/472727-new-2.jpg?sw=500&sh=500&sm=fit" aria-hidden="false">');
        // white
        window.jQuery(`.${ID}-productSlider .${ID}-images`).slick('slickAdd','<img class="HC088-image" attr="472725" src="https://www.hotelchocolat.com/dw/image/v2/AAZP_PRD/on/demandware.static/-/Sites-hotelchocolat-master-catalog/default/dwdc76ae1b/images/472725-new-2.jpg?sw=500&sh=500&sm=fit" aria-hidden="false">');
        // stellar white
        ...
        // copper
        window.jQuery(`.${ID}-productSlider .${ID}-images`).slick('slickAdd','<img class="HC088-image" attr="472726" src="https://www.hotelchocolat.com/dw/image/v2/AAZP_PRD/on/demandware.static/-/Sites-hotelchocolat-master-catalog/default/dw74e9c207/images/472726-new-2b.jpg?sw=500&sh=500&sm=fit" aria-hidden="false">');
    
        window.jQuery(`.${ID}-productSlider .${ID}-images`).slick('slickAdd','<img class="HC088-image" attr="472803" src="https://www.hotelchocolat.com/dw/image/v2/AAZP_PRD/on/demandware.static/-/Sites-hotelchocolat-master-catalog/default/dw9dc912a8/images/472803-new.jpg?sw=500&sh=500&sm=fit" aria-hidden="false">');
    }
}