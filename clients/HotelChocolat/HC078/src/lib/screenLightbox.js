    ...
    create() {  
      ...
      element.innerHTML = `
        <div class="${ID}-modalInner">
            ...
            <div class="${ID}-question ${ID}-country ${ID}-active" step="1">
            ...
            <div class="${ID}-question ${ID}-currentcountry" step="2">
            ...
            <div class="${ID}-question ${ID}-dialingCode" step="3">
            ...
            <div class="${ID}-question ${ID}-allowed" step="4">
                <div class="${ID}-innerText">
                    <h4>DISCLAIMER – IMPORTANT</h4>
                ...
                <div class="${ID}-button">Continue</div>
            </div>
