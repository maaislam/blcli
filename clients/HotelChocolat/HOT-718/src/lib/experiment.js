...
const quickLinks = [
  {
    ...
    url: '/uk/shop/valentines-day-gifts/',
    image:
...
const init = () => {
  pollerLite(['#header-promo-banner'], () => {
    ...
    const quickLinksElem = document.querySelectorAll(`.${ID}-quick-links a.quick-links__link`);
    if (quickLinksElem.length > 0) {
      quickLinksElem.forEach((link) => {
