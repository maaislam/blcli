...
window.addEventListener('load', () => {
  ...
  // '.availability-block .not-available-msg',
// OUT OF STOCK or 404 PAGES
  () => {
      let poller = false;
      if (document.querySelector('.availability-block .not-available-msg')
      || document.querySelector('#add-to-cart.button-fancy-large.add-to-cart-disabled.out-of-stock')
      || document.querySelector('#primary input[name="errorID"][value="404"]')) {
        poller = true;
      }
