              ...
              mutations.forEach(function(mutation) {
                  if (oldHref != document.location.href) {
                      oldHref = document.location.href;
                        document.documentElement.classList.remove('HC150');
                        document.documentElement.classList.remove('HC150-1');
                        document.documentElement.classList.remove('HC150-2');
                        document.documentElement.classList.remove('HC150-3');
                        document.documentElement.classList.remove('HC150-control');
