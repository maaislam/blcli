const hideOptionalInputFields = (id) => {
    ...
    const countryField = document.querySelector('#dwfrm_multishipping_editAddress_addressFields_country');
    const countryRow = countryField.closest('.form-row');
    countryRow.classList.add(`${id}__hide`);

    //hide optional mobile number
    const mobileNumber = document.querySelector('#dwfrm_multishipping_editAddress_userInfo_customer_mobilephone');
    ...
    // const countryInput = document.querySelector('#dwfrm_multishipping_editAddress_addressFields_county');
    ...
    // const address2Input = document.querySelector('#dwfrm_multishipping_editAddress_addressFields_address2');
    ...
    // const companyNameInput = document.querySelector('#dwfrm_multishipping_editAddress_addressFields_companyName');
