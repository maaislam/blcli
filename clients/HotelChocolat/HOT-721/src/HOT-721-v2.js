(function () {
  ...
  const init = () => {
    ...
    const descriptionActiveElem = document.querySelector('.HOT-678-accordion.HOT-678-description-active');
    if (descriptionActiveElem) descriptionActiveElem.classList.remove('HOT-678-description-active');
  };
  ...
  pollerLite(
    ['body', () => typeof window.dataLayer === 'object', () => typeof isPdpPage === 'object', '#pdpMain > .product-detail'],
    activate
  );
})();
