...
export default function v2() {
	(function renderHeroBanner() {
		...
		const newEl = HeroBanner(
			...
			"https://blcro.fra1.digitaloceanspaces.com/SS-441/v2.png",
			"Book your scan",
			"/book/location",
			"We think everyone deserves access to advanced eyecare.",
			"Book a scan to get the full picture of your eye health"
		);
	...
	(function renderComparison() {
		...
		const newEl = Comparison(
			...
			[
				{
					image: "https://content.specsavers.com/sib/content-pages/img/split/Fundas-OCT_280x205.jpg",
		...
		if (currentEl) {
			...
			(function removeOtherContent() {
				...
				document
					...
					.remove();
				document
					.querySelectorAll(".sib-text-multiple-column")[1]
					.remove();
			})();
		}
	})();
