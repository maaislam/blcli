...
import { angularCompile, loadSingleProductData } from '../../../../../../../lib/utils/avon';
            ...
            <div class="${componentName}_content">
              ...
              <div class="${componentName}_details">
                <div ng-if="product.RatingCount" class="${componentName}_reviewsWrapper">
                  ...
                  <p><span ng-bind="product.RatingCount"></span> recenze</p>
                </div>
...
`);
    ...
    this.bindEvents();
    const desc = productData.MetaDescription.replace(productData.Name, '')
      .replace('Sada obsahuje:', `<span class='${componentName}_descriptionLabel'>Sada obsahuje:</span>`)
      .replace(
        'Hlavní složky:',
