...
export default () => {
  ...
  const title = $('#Breadcrumbs div:last-child span').text();
    ...
    const markup = `
      <div class="${ID}_container ${ID}_topLinks">
        <div class="${ID}_container ${ID}_topLinksRow">
          <a class="${ID}_mobile" href="/6498-6586/darky/parfemove-sady">Parfémové sady</a>
          <a class="${ID}_mobile" href="/6498-6587/darky/dekorativni-kosmetika">Dekorativní kosmetika</a>
          <a class="${ID}_mobile" href="/6498-6588/darky/pece-o-telo">Péče o tělo</a>
          <a class="${ID}_mobile" href="/6498-6589/darky/pece-o-plet">Péče o pleť</a>
          <a class="${ID}_mobile" href="/6498-6590/darky/pece-o-vlasy">Péče o vlasy</a>
          <a href="/6498-6525/darky/darky-do-300-kc">do 300 Kč</a>
          <a href="/6498-6526/darky/darky-do-500-kc">do 500 Kč</a>
          <a href="/6498-6527/darky/darky-nad-500-kc">nad 500 Kč</a>
          <a href="/6498-6528/darky/pro-ni">Pro ni</a>
          <a href="/6498-6529/darky/pro-nej">Pro něj</a>
          <a href="/6498-6530/darky/pro-deti">Pro děti</a>
        </div>
  ...
  const arrangeCategories = () => {
    ...
    const set3 = [];
    cats.forEach((c) => {
      if (c.innerText.trim().match(/Dárky/)) {
        set2.push(c);
      } else if (c.innerText.trim().match(/Pro\s/)) {
        set3.push(c);
      } else {
        set1.push(c);
      }
  ...
  const modifyProductListTemplate = () =>
    new Promise((resolve, reject) => {
      ...
      if ($template.find(`.${ID}_modalButton`).length < 1) {
        $image.after(`
        <div class="${ID}_modalButton vi-btn" ng-click="$parent.$parent.openImageModal(product, Qty, addProductToCart, viewProduct)">Co je uvnitř?</span></div>
        `);
      }
