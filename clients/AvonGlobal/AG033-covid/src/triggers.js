    ...
    .then((data) => {
      ...
      rootScope.$on('CartService_GetCartSuccess', () => {
        pollerLite([
          ...
          pollerLite(['.imb-cart-notification-text'], (elements) => {
            if(elements && elements[0]) {
              elements[0].innerHTML = 'Due to COVID-19, to keep our reps safe, we have temporarily removed rep delivery as an option';
            }
          });
        });
      });
