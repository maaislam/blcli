              ...
              (function pollForElements() {
                if (
                  ...
                  swiperSlides.forEach((slide, i) => {
                    ...
                    const productSku = matchingProd[matchingProd.length - 1].url.split('prodId=')[1].split('&')[0];
                    const inStock = matchingProd[matchingProd.length - 1]['in_stock'] && productSku.indexOf('-') !== -1;
                    console.log(inStock);
