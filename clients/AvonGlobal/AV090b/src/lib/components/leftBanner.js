const renderLeftBanner = (parentElm, id, heroImg, href, subtitle1, subtitle2) => {
  ...
  const htmlStr = `
        ...
        <a class="${id}__leftbanner" href="${catLink}" style="background-image:linear-gradient(0deg, rgba(48, 48, 48, 0.76) 0%, rgba(48, 48, 48, 0) 100%), url(${heroImage});height: ${containerHeight}px">      
