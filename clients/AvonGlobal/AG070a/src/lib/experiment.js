  ...
  const init = () => {
    ...
    $(".ProductDescription").before(`
      ...
      content.textImage1.bgColor
        ...
        <div class="${ID}_textImageWrapper ${ID}_${thisPage}" style="background-color: #${
      ...
      content.textImage2.image
        ...
        <div class="${ID}_parallaxWrapper ${ID}_parallaxWrapperBottom ${ID}_${thisPage}" style="background-image: url('${
      content.parallax2.bgImage
        ...
        <div class="${ID}_textImageWrapper ${ID}_${thisPage}" id="${ID}_textWrapper3" style="background-color: #${
